...
We call this period of time the "challenge period" because it is the time during which a transaction can be challenged with a [fault proof](/concepts/architecture/rollups/overview#fault-proofs).
