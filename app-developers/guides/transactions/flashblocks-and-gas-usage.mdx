...
In practice, transactions are sent to execution-layer RPC nodes (likely via proxyd) and only transactions accepted into the txpool are gossiped to the sequencer for inclusion.
