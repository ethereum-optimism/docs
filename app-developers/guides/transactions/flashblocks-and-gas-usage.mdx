...
More generally, designing applications to avoid extremely large single transactions is good long-term practice since, with upcoming protocol changes (e.g. Fusaka on L2), transactions will be capped at 16.7M gas anyway.
