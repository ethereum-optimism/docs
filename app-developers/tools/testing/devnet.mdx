...
<Steps>
  <Step title="Get testnet ETH from the Superchain Faucet">
...
<Steps>
  <Step title="Get Sepolia ETH from the Superchain Faucet">
  ...
  <Step title="Send the Sepolia ETH to the devnet">
  ...
  <Step title="Wait for bridging to complete">
