...
description: Learn how to use the @eth-optimism/viem package to transfer ERC-20 tokens between Layer 1 (Ethereum or Sepolia) and Layer 2 (OP Mainnet or OP Sepolia).
---
...
The `@eth-optimism/viem` package supports any of the [Superchain networks](/op-mainnet/network-information/connecting-to-op).
If you want to use a network that isn't included by default, you can simply [instantiate the package with the appropriate contract addresses](/app-developers/quickstarts/starter-kit).
