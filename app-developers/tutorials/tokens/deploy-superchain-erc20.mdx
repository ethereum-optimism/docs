...
For more information on how it works, [see the explainer](/op-stack/interop/superchain-erc20).
...
*   Use the [SuperchainERC20 Starter Kit](/app-developers/quickstarts/starter-kit) to deploy an `SuperchainERC20` token on the devnet.

## Step by step explanation

<Steps>
  <Step title="Install the prerequisites and the SuperchainERC20 Starter Kit">
  ...
  The Starter Kit already deploys a `SuperchainERC20` token to [Supersim](/> app-developers/tools/development/supersim).
...
*   Learn how to [transfer tokens between chains inside the Superchain](/app-developers/tutorials/tokens/transfer-superchainERC20).
