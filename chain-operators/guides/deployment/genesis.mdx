...
*   Learn how to [initialize](/node-operators/guides/base-config#initialization-via-genesis-file) `op-geth` with your `genesis.json` file
*   Learn how to [configure](/node-operators/guides/base-config#configuring-op-node) `op-node` with your `rollup.json` file
