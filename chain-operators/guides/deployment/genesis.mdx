---
title: Chain genesis creation
description: Learn how to create genesis and rollup configuration files.
---

# Overview

After deploying the L1 system contracts for your OP Stack chain using `op-deployer`, you need to generate two files to run nodes on the L2 network:
