...
| :---------------------- | :-----: | :------------- | :--------------|
| `operatorFeeScalar`     | 0       | Chain-specific | uint32 scalar  |
| `operatorFeeConstant`   | 0       | Chain-specific | uint64 scalar  |
...
<Info>
  The operator fee is only applied on chains that have enabled the Isthmus upgrade and following ones.
</Info>
