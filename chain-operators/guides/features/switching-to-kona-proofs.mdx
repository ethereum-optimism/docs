...
- Use the same dispute game implementation (`FaultDisputeGame.sol`).
...
<Steps>
  ...
  <Step title="Ensure op-challenger is Kona-ready">
    ...
    <Info>
      These settings should already be in place from the cannon+kona upgrade preparation. This step is about double-checking before you switch.
    </Info>
    ...
    2. **Prestate URLs**
       ...
       For operational simplicity, a single location for all prestates is recommended.
