...
<Steps>
  <Step title="Retrieve existing EIP-1559 values">
    ...
    ```solidity
    elasticity = SystemConfig.eip1559Elasticity() // e.g. 6
    denom = SystemConfig.eip1559Denominator() // e.g. 50
    limit = SystemConfig.gasLimit() # e.g. 30_000_000 gas, 30Mgas    
    ```
  ...
  <Step title="Set new EIP-1559 params">
    ...
    ```solidity
    SystemConfig.setEIP1559Params(denom, 3)
    ```
