...
The L1 Fee charges for posting L2 data to L1. It multiplies a scalar‑weighted L1 price by an estimated FastLZ‑compressed transaction size.
...
- **operatorFeeConstant** (flat constant, wei).
- **operatorFeeScalar** (per gas scalar).
