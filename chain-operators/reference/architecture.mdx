...
[OP Stack section](/op-stack/protocol/getting-started) of our documentation.
...
We recommend setting up some archive nodes for internal RPC usage, primarily used by the challenger and security monitoring tools like [monitorism](/operators/chain-operators/tools/chain-monitoring#monitorism).
