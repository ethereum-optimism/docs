...
2.  **Governance alignment:**
    *   Adherence to the [Standard Rollup Charter](/superchain/concepts/blockspace-charter#the-standard-rollup-charter).
...
For a detailed list of standard configurations, refer to the [Standard rollup configuration page](/superchain/concepts/blockspace-charter).

## Superchain Registry

The [Superchain Registry](/superchain/superchain-information/superchain-registry) is the authoritative index of all chains within the Superchain ecosystem. It ensures:
...
*   [Blockspace Charter](/superchain/concepts/blockspace-charter)
