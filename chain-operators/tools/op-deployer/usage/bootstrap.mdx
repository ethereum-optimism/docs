...
description: Learn how to deploy global singletons and implementation contracts for new superchains.
---

<Info>
If you are joining an existing superchain, you can skip to the [`init`](/chain-operators/tools/op-deployer/usage/init) and [`apply`](/chain-operators/tools/op-deployer/usage/apply) commands to create your L2 chain(s).
</Info>
