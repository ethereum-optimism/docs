...
Even if your chain is not included in the [superchain-registry](/superchain/superchain-information/superchain-registry), you can specify a custom configuration:
