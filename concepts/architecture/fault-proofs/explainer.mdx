...
<br />
<Image src="/public/img/op-stack/protocol/fp-permissionless.png" alt="Permissionless Fault Proofs flow" width={700} height={600} />
...
*   Ready to get started? Review the [FP Components](/stack/fault-proofs/fp-components) to learn how the different components work together to enhance decentralization in the Optimism ecosystem.
