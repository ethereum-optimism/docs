...
For instance, a powerful open-source block explorer that makes it easier for users to inspect [the Superchain](https://app.optimism.io/superchain/?utm_source=op-docs&utm_medium=docs) would be a great addition to the OP Stack.
...
Of course, software that has an impact for the Optimism Collective is eligible to receive [Retroactive Public Goods Funding](https://app.optimism.io/retropgf?utm_source=op-docs&utm_medium=docs). Build for the OP Stack — get rewarded for writing great open source software. What's not to love?
