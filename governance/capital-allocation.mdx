...
You can find more information about revenue in the [Superchain Revenue Explainer](https://community.optimism.io/op-token/superchain-revenue-explainer) documentation. 
