...
This guide covers [Ethereum Attestation Service ("EAS")](https://attest.sh/), an open-source public good that is included as a predeploy in the OP Stack. It also covers EAS contract addresses, how to read and write attestations, and indexing.
    ...
    <Accordion title="Schemas">
        ...
        **Schemas related to project creation and Retro funding application**
        ...
        - For more information on working with attestations, see [Build Decentralized Identity Apps with Attestations](https://community.optimism.io/identity/about-attestations).
        - To see a list of applications using EAS, see [Attestation Apps](https://community.optimism.io/identity/applications).
    </Accordion>
...
<Accordion title="What is the Optimism Foundation?">
    The Optimism Foundation is a Cayman Islands foundation company. It operates to support the establishment of the [Optimism Collective](https://community.optimism.io/welcome/welcome-overview), the development of the Optimism ecosystem, and the technology that powers it.
