...
With **Flashblocks enabled**, block construction is incremental, and *transaction inclusion depends on the gas already consumed within the block*, not just the theoretical maximum.
...
### 1. Leave Headroom for Large Transactions
...
### 2. Expect Variable Gas Availability During Congestion
