...
<Info>
        ...
        The JSON-RPC API will become available on port 8545.
        Refer to the `Nethermind` [configuration documentation](/node-operators/configuration/execution-clients/nethermind) for more detailed information about available options.
