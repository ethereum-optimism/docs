...
<Info>
  The Jovian hard fork for the Sepolia OP Stack chains will be activated at Wed 19 Nov 2025 16:00:01 UTC (`1763568001`) and the Mainnet OP Stack chains will be optimistically activated at Tue 2 Dec 2025 16:00:01 UTC (`1764691201`) pending governance approval.
...
<Steps>
  ...
  The releases contain both the Jovian Mainnet and Sepolia OP Stack chain activation timestamps.
...
<Note>
  The OP Stack will be bundling [Fusaka support](/notices/fusaka-notice) and the Mainnet Jovian hard fork support into a single absolute prestate.
</Note>
