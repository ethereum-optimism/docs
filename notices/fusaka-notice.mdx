...
**Note:** `op-node` v1.14.1 and later use the new `/eth/v1/beacon/blobs/` API for fetching blob data from L1 beacon nodes. If you run a reverse proxy/load balancer in front of your beacon API, ensure it correctly forwards all query parameters. 
