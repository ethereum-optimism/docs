...
<Note>
  The Superchain will be bundling the new absolute prestate for Fusaka support and the Mainnet [Jovian hard fork](/notices/upgrade-17).
  This step will only need to be performed once.
</Note>
