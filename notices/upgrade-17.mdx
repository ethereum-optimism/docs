...
<Info>
  The Jovian hard fork for the Sepolia Superchain will be activated at Wed 12 Nov 2025 16:00:01 UTC (`1762963201`) and the Mainnet Superchain will be activated at Tue 25 Nov 2025 16:00:01 UTC (`1764086401`).

  The upgrade will be executed by OP Labs on the following chains: `OP`, `Base`, `Soneium`, `Ink`, `Unichain`, `Metal`, `Mode`, `Zora`, `Arena-Z`, `Swell` (Swell Mainnet only).
