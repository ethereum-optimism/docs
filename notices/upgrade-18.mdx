...
| -------------- | ------- | ----- |
| `op-challenger` | [`op-challenger/v1.8.0`](https://github.com/ethereum-optimism/optimism/releases/tag/op-challenger%2Fv1.8.0) | Must be updated **prior** to the upgrade for permissionless fault proof chains. |
| `op-dispute-mon` | [`op-dispute-mon/v1.4.0`](https://github.com/ethereum-optimism/optimism/releases/tag/op-dispute-mon%2Fv1.4.2) | Must be updated **prior** to the upgrade for permissionless fault proof chains. |
...
<Steps>
  ...
  *   Mainnet and Sepolia: `OP`, `Base`, `Ink`, `Soneiuim`, and `Unichain`
  ...
  <Step title="Upload your new preimage files">
    ...
    You'll find the new kona cannon file at `kona/prestate-artifacts-cannon/prestate-proof.bin.gz`. Rename that file to have the absolute prestate hash as the filename so it looks like `0x0323914d3050e80c3d09da528be54794fde60cd26849cd3410dde0da7cd7d4fa.bin.gz`.
