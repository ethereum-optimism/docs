...
| `op-dispute-mon` | [`op-dispute-mon/v1.4.2`](https://github.com/ethereum-optimism/optimism/releases/tag/op-dispute-mon%2Fv1.4.2) | Must be updated **prior** to the upgrade for permissionless fault proof chains. |
