---
title: Upgrade 19 - Automated Superchain Revenue Sharing
...
<Info>
  Upgrade 19 is purely a smart contract upgrade. There are no hardforks activating during this upgrade.
</Info>
...
### Revenue distribution becomes automated

Manual revenue disbursement processes will no longer be required after this upgrade.
...
No action required. For OP Mainnet, Ink, and Soneium, the upgrade will be executed via the `ProxyAdminOwner` multisig using the `RevShareContractsUpgrader`.

### Non OP Governed Chains

Chains whose `ProxyAdminOwner` is not controlled by the Foundation must:

- Perform the upgrade template themselves (see superchain-ops reference).
...
![Screenshot 2026-02-19 at 10.08.27.png](attachment:f2c756ec-de88-45db-ae70-92384cd41929:Screenshot_2026-02-19_at_10.08.27.png)

![Screenshot 2026-02-19 at 10.08.17.png](attachment:7fa1676b-f1fd-462b-848f-d39505d5a679:Screenshot_2026-02-19_at_10.08.17.png)

![Screenshot 2026-02-19 at 10.09.18.png](attachment:3d4b4dcf-9dde-46e6-bfa2-2c2da438d0da:Screenshot_2026-02-19_at_10.09.18.png)

---

## Execute the L1 Contract Upgrade

The upgrade must be executed via delegatecall from the `ProxyAdminOwner` multisig to the deployed `RevShareContractsUpgrader` (see superchain-ops reference).
...
- Design Docs:
- Revenue Sharing: https://github.com/ethereum-optimism/design-docs/blob/main/protocol/revenue-sharing.md
- Fee Splitter: https://github.com/ethereum-optimism/design-docs/blob/main/protocol/fee-splitter.md
- Specs:
- https://github.com/ethereum-optimism/specs/tree/main/specs/protocol/revshare
- Implementation PR:
- https://github.com/ethereum-optimism/optimism/pull/17536
