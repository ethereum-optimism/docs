...
[Cannon](/stack/fault-proofs/cannon) is the default FPVM used in all disputes. [MIPS](/concepts/architecture/fault-proofs/mips) is the onchain smart contract implementation of Cannon that can be implemented due to the modularity of the dispute game.
