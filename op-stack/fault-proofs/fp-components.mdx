...
[Cannon](/op-stack/fault-proofs/cannon) is the default FPVM used in all disputes. [MIPS](/concepts/architecture/fault-proofs/mips) is the onchain smart contract implementation of Cannon that can be implemented due to the modularity of the dispute game.
...
*   For more detail on Cannon and its default operation as part of Optimism's Fault Proof Virtual Machine, see [Cannon FPVM](/stack/fault-proofs/cannon).
*   For a detailed walk-thru of significant changes to Fault Proof Mainnet, see [FP Mainnet Security](/stack/fault-proofs/fp-security).
