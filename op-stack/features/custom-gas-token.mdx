...
*   **Learn more**: Read the [full design specification](https://github.com/ethereum-optimism/design-docs/blob/main/protocol/custom-gas-token.md) for technical details
