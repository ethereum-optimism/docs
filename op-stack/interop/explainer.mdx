...
Superchain interoperability among OP Stack chains is enabled via a new service called [*OP Supervisor*](/chain-operators/reference/components/op-supervisor).
...
In Superchain interop, [the traditional safe level](/op-stack/transactions/transaction-finality#steps-to-finality) of a block is divided into two types of safety.
