...
<Steps>
  <Step title="Learn the Basics">
    Understand how Superchain interoperability works by reading our [comprehensive explainer](/> op-stack/interop/explainer)
  </Step>
...
*   [Superchain Interoperability Explainer](/> op-stack/interop/explainer) - Deep dive into the technical details
