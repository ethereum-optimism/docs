...
This doc mostly covers the charters, but references the superchain-registry as they are all deeply connected. Read more about the superchain-registry [here](/op-stack/ecosystem/superchain-registry).
...
By integrating with the Standard Rollup Charter, the registry offers an automated and transparent validation system. This ensures chains can independently demonstrate compliance. For additional details, refer to the [superchain-registry documentation](/op-stack/ecosystem/superchain-registry).
