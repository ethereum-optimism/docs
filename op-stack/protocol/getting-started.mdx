...
The OP Stack of today was built to support [the Optimism Superchain](/superchain/introduction/superchain-explainer), a proposed network of L2s that share security, communication layers, and a common development stack (the OP Stack itself).
...
As the [Superchain](/superchain/introduction/superchain-explainer) begins to take shape, the OP Stack can evolve alongside it, to include the message-passing infrastructure that allows different chains to interoperate seamlessly.
...
*   If you're excited to join the Superchain, launch your first [Superchain-ready L2](/chain-operators/tutorials/create-l2-rollup/create-l2-rollup) or dive directly into the OP Stack codebase to learn more.
