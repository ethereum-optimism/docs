...
<Info>
  Stay up to date on the OP Stack by subscribing to the [Optimism Developer Blog](https://blog.oplabs.co/)
</Info>
...
If you'd like to launch an OP Stack-ready L2, check out our guide for running a chain based on the Bedrock release of the OP Stack.
