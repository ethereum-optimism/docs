...
<Tabs items={['op-geth', 'Nethermind']}>
  ...
  <Tabs.Tab>
    <Steps>
  {<h3>Navigate to your `Nethermind` directory</h3>}
        ...
        The JSON-RPC API will become available on port 8545.
        Refer to the `Nethermind` [configuration documentation](/operators/node-operators/configuration/execution-config#nethermind) for more detailed information about available options.
