...
<CardGroup cols={2}>
  <Card title="Bridging basics" href="/app-developers/bridging/basics" icon="shapes" />
  <Card title="Standard bridge" href="/app-developers/bridging/standard-bridge" icon="shapes" />
  <Card title="Custom bridges" href="/app-developers/bridging/custom-bridge" icon="shapes" />
  <Card title="Sending data between L1 and L2" href="/app-developers/bridging/messaging" icon="shapes" />
</CardGroup>
