...
The [Superchain Token List](/stack/chain/tokenlist) exists to help users and developers find the right bridged representations of tokens native to another blockchain.
