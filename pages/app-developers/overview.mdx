...
If you're brand new to OP Mainnet, try starting with the guide on [deploying a basic contract](/stack/chain/getting-started).
...
You might also want to check out the [testing on OP Networks guide](/stack/chain/testing/testing-apps) and the tutorial on [running a local development environment](/stack/chain/testing/dev-node) to help you feel totally confident in your OP Mainnet deployment.
...
<Cards>
  ...
  <Card title="Testing Apps on OP Mainnet" href="/stack/chain/testing/testing-apps" icon={<img src="/img/icons/shapes.svg" />} />
</Cards>
