...
*   Learn how to start Supersim in [vanilla (non-forked) mode](/app-developers/supersim/reference/vanilla) or [forked mode](/app-developers/supersim/reference/fork).
