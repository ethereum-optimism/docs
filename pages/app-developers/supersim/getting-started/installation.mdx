...
*   Explore [Supersim](/app-developers/supersim/explainer) features, particularly in [vanilla mode](/app-developers/supersim/reference/vanilla), which starts 3 chains (L1 and L2).
