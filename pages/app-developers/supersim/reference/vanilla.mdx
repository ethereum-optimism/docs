...
*   Explore the Supersim [included contracts](/app-developers/supersim/chain-env/included-contracts) being used to help replicate the Superchain environment.
*   Get network details about the two OP Stack systems spun up in vanilla mode: [OPChainA (chainID 901)](/app-developers/supersim/chain-env/chain-a) and [OPChainB (chainID 902)](/app-developers/supersim/chain-env/chain-b).
*   Learn how to [deposit transactions](/app-developers/supersim/deposit-transactions) with Supersim, using a much simpler approach that bypasses the derivation pipeline.
