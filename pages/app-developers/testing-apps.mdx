...
It is a best practice to design and run thorough tests across an OP test network, either in your [local multichain development environment](/app-developers/supersim/explainer), our [devnets](/stack/public-devnets), or on [the test network](/superchain/networks#op-sepolia), depending on your use case.
...
If that is the case, you can use [mainnet forking](/app-developers/supersim/reference/fork).
