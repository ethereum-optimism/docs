...
description: >-
  Learn about different block explorers you can use to interact with contracts
  and view transaction history for OP Mainnet and OP Sepolia.
lang: en-US
content_type: guide
topic: block-explorers
personas:
  - app-developer
categories:
  - testnet
...
However, you **can** access transaction history between 23 June 2021 and the final regenesis using a number of different tools. For detailed instructions, see [Regenesis History](/node-operators/guides/management/regenesis).
