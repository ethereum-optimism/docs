...
[Supra](https://supra.com/) is a MultiVM Layer 1. It recorded 500k TPS on 300 nodes with sub-second consensus latency. It's the first chain with full vertical integration of **Native Oracles**, **dVRF (Verifiable Randomness)**, Block Level Automation, and Cross Chain Communication, creating a unified platform for building Super dApps.

#### Oracles
Start Building using Supra Oracle: Refer to this [Docs Page](https://docs.supra.com/oracles) to gain a deeper understanding and detailed guides on integration.
...
Check Supra [dVRF](https://supra.com/vrf-product/), a novel on-chain randomness generation mechanism, Supra’s decentralized VRF is designed to power dApps with effectively random outcomes that are responsive, scalable, and easily verifiable.
