...
**Description**: [dRPC](https://drpc.org) offers [free and paid plans](https://drpc.org/pricing) for the following [networks](https://drpc.org/chainlist):
...
*   To be listed, providers must support at least one network in the [Superchain](https://github.com/ethereum-optimism/superchain-registry/tree/main)
