...
Check out the tutorial on [Estimating Transaction Costs on OP Mainnet](/app-developers/tutorials/sdk-estimate-costs) to learn how to use the Viem library to estimate the L1 data fee for your transaction.
