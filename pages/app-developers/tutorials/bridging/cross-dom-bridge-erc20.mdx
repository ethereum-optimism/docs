...
<Steps>
  ...
  ```js file=<rootDir>/public/tutorials/cross-dom-bridge-erc20.js#L3-L16 hash=0d8d44c3e60e00b3c5120811eb49df82
  ```
...
<Steps>
  ...
  ```js file=<rootDir>/public/tutorials/cross-dom-bridge-erc20.js#L19-L20 hash=e986a6f713e3e2d643e833f2b8ea35e8
  ```

  {<h3>Create the RPC providers and wallets</h3>}

  ```js file=<rootDir>/public/tutorials/cross-dom-bridge-erc20.js#L22-L45 hash=403533b67c27bd99359d5fb627af4fae
  ```
  ...
  ```js file=<rootDir>/public/tutorials/cross-dom-bridge-erc20.js#L48-L49 hash=46514380d42d150087f8ddee9370bb74
  ```
...
<Steps>
  ...
  ```js file=<rootDir>/public/tutorials/cross-dom-bridge-erc20.js#L52-L94 hash=aca619885406d14ba091e8c1aff23a5a
  ```

  {<h3>Check initial balance</h3>}

  ```js file=<rootDir>/public/tutorials/cross-dom-bridge-erc20.js#L97-L106 hash=06d131054996db9aa0679d8efa00534e
  ```
...
<Steps>
  ...
  ```js file=<rootDir>/public/tutorials/cross-dom-bridge-erc20.js#L109-L111 hash=b324efb8323fda08c62823e80bda75d9
  ```
  ...
  ```js file=<rootDir>/public/tutorials/cross-dom-bridge-erc20.js#L113-L120 hash=1019de7f356be5903cf655801d55eecb
  ```
  ...
  ```js file=<rootDir>/public/tutorials/cross-dom-bridge-erc20.js#L123-L128 hash=808ed3788e47f5af11ece6192a19653b
  ```
  ...
  ```js file=<rootDir>/public/tutorials/cross-dom-bridge-erc20.js#L131-L142 hash=3d36c7b7142796860cf66be1e7d77770
  ```
  ...
  ```js file=<rootDir>/public/tutorials/cross-dom-bridge-erc20.js#L145-L151 hash=56fb1e18b0eb129f014ba90c6a634497
  ```
  ...
  ```js file=<rootDir>/public/tutorials/cross-dom-bridge-erc20.js#L153-L160 hash=e5e5b43036d4dc4808eb27cfd52f2532
  ```
  ...
  ```js file=<rootDir>/public/tutorials/cross-dom-bridge-erc20.js#L162-L170 hash=50547649f9b515a7916b81fa1e8c15f0
  ```
...
<Steps>
  ...
  ```js file=<rootDir>/public/tutorials/cross-dom-bridge-erc20.js#L177-L191 hash=0dfa085d18ca15f5dca82f5ad3e4cf10
  ```
  ...
  ```js file=<rootDir>/public/tutorials/cross-dom-bridge-erc20.js#L191-L192 hash=774aa36ea73edf61dbecca2f8e52564a
  ```
  ...
  ```js file=<rootDir>/public/tutorials/cross-dom-bridge-erc20.js#L194-L205 hash=4cac4ef6add5547940f94f6e2d38cd51
  ```
  ...
  ```js file=<rootDir>/public/tutorials/cross-dom-bridge-erc20.js#L207-L213 hash=24a7f657241507cc22ea808002c2b723
  ```
  ...
  ```js file=<rootDir>/public/tutorials/cross-dom-bridge-erc20.js#L217-L227 hash=b145a8d0dcf5b49ef749807f8bff74d0
  ```
</Steps>
