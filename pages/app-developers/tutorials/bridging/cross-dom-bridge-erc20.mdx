...
<Steps>
  ...
  ```js file=<rootDir>/public/tutorials/cross-dom-bridge-erc20.js#L109-L115 hash=0a731b1c29bad0b714d91ebe48db187d
  ```
...
<Steps>
  ...
  ```js file=<rootDir>/public/tutorials/cross-dom-bridge-erc20.js#L145-L151 hash=f607c02ee719909ba706ea8d40d26710
  ```
  ...
  ```js file=<rootDir>/public/tutorials/cross-dom-bridge-erc20.js#L145-L154 hash=c8d3ef00a69f5d328b66a129fe23c865
  ```
...
<Steps>
  ...
  ```js file=<rootDir>/public/tutorials/cross-dom-bridge-erc20.js#L148-L154 hash=67b7eb08917b042c8846c627cd316ebd
  ```
  ...
  ```js file=<rootDir>/public/tutorials/cross-dom-bridge-erc20.js#L156-L163 hash=9ee233eaa1711443ff15e0d28d2da190
  ```
  ...
  You first need to wait for the transaction receipt.

  ```js file=<rootDir>/public/tutorials/cross-dom-bridge-erc20.js#L165-L167 hash=688f6479aaf1cb4d0b46c645a34ef9d3
  ```
  ...
  ```js file=<rootDir>/public/tutorials/cross-dom-bridge-erc20.js#L169-L175 hash=2e2f8b3416dcfc58fd1e97da3b43197e
  ```
</Steps>
