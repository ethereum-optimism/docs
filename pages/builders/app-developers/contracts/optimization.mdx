...
App developers might already be familiar with the concept of [gas optimization](https://github.com/0xisk/awesome-solidity-gas-optimization) to decrease the cost of interacting with smart contracts.
...
Custom encodings are typically less complex than general-purpose calldata compression libraries but carry additional complexity no matter what.
