...
<Tabs items={['depositETH', 'Full Code']}>
  <Tabs.Tab>
    <Steps>
      ...
      ```js file=<rootDir>/public/tutorials/cross-dom-bridge-eth.js#L49-L50 hash=b244b4b898056b84811822273a5fc7cb
      ```
      ...
      ```js file=<rootDir>/public/tutorials/cross-dom-bridge-eth.js#L52-L53 hash=d2a616afac321edbb2ec4b7592464ea4
      ```
  ...
  <Tabs.Tab>
      ```js file=<rootDir>/public/tutorials/cross-dom-bridge-eth.js#L3-L63 hash=f83a4b9d811a275e3c182524e88a733b
      ```
  </Tabs.Tab>
</Tabs>
