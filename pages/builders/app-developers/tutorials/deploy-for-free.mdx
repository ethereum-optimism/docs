...
Once you have linked your wallet to the Superchain Dev Console, go to console.optimism.io and click the banner for “Launch anywhere in the Superchain for free”. On the contracts section, add your contract address, deployment transaction hash, deployer address, and select the chain you deployed on. 
