...
```js file=<rootDir>/public/tutorials/sdk-estimate-costs.js#L21-L26 hash=96e2f9bcece6c455f64c82e44bce1105
```
...
```js file=<rootDir>/public/tutorials/sdk-estimate-costs.js#L37-L38 hash=afbf520615c15f71a84eec2566c393aa
```
