...
You can choose to connect to OP Mainnet via our rate-limited public endpoints, [private endpoints from infrastructure providers](/chain/networks), or [by running your own node](/builders/node-operators/tutorials/node-from-source).
...
[The EIP 1559 parameters](/stack/differences#pre--EIP--155-support) have different values in OP Mainnet (and many other OP Stack chains) than those on L1 Ethereum.
