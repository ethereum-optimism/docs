...
<Image 
  src="/img/builders/chain-operators/ingress-traffic-diagram.png" 
  alt="Ingress Traffi Diagram" 
  width={400} 
  height={400} />
...
1. Track backend consensus (latest, safe, finalized blocks), peer count and sync state.
1. Re-write requests and responses to enforce consensus.
1. Load balance requests across backend services.
1. Cache immutable responses from backends.
1. Provides metrics to measure request latency, error rates, and the like.
...
<Image 
  src="/img/builders/chain-operators/sequencer-node.png" 
  alt="Ingress Traffi Diagram" 
  width={400} 
  height={400} />
...
<Image 
  src="/img/builders/chain-operators/replica-node.png" 
  alt="Ingress Traffi Diagram" 
  width={200} 
  height={200} />
