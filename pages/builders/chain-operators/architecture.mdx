...
These clients and services work together to enable the sequencer role on the L2 network.
Sequencer nodes gather proposed transactions from users and publish them to the L1.
...
- replica nodes forward eth_sendRawTx to sequencer 

tx flow 
non eth_sendRawTransaction rpcs:
