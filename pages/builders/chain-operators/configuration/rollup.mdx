...
*   **Recommended value:** 
*   **Notes:** Must not be `address(0)`
*   **Standard Config Requirement:** The implementation contract must be the latest
governance-approved version of the OP Stack codebase. If the chain has been upgraded previously,
all past versions must have been standard releases of the codebase.
