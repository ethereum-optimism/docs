...
Your intent-config-type determines which fields you can set to custom values. 
In all cases, you need to replace any zero-value address with your own custom values."
