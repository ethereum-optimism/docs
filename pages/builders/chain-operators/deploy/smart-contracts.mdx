...
{<h3>Create an intent file</h3>}

*   Define the configuration of your chain in an intent file.
*   This file specifies the deployment parameters for both L1. 
Follow the instructions provided in the [configure your chain](/tools/op-deployer#init-configure-your-chain) section to generate the intent file.

{<h3>Run the `apply` command</h3>}
