...
This diagram illustrates the process of migrating USDC. Below is a detailed explanation of each step:
...
*   Bridged USDC inherits the same security model as the OP Chain rollup.
...
### Does the custom bridges break an OP Chain operator's agreement with the law of chains?
