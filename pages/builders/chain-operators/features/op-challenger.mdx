...
<Steps>
  ...
  *   For custom networks not in the [superchain-registry](https://github.com/ethereum-optimism/superchain-registry/blob/main/superchain/configs/chainList.json) yet, the `--game-factory-address` and rollup must be specified:
