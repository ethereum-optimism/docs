...
*   Interested in adding your own Preinstalls? Check out the [BindGen CLI tool](https://github.com/ethereum-optimism/optimism/tree/v1.7.3/op-bindings/bindgen) and be sure to read the note about [Contracts that Don't Make Good Preinstalls](https://github.com/ethereum-optimism/optimism/tree/v1.7.3/op-bindings/bindgen#contracts-that-dont-make-good-preinstalls) before starting this process.
