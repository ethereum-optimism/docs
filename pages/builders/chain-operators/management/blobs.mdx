...
back to posting data to calldata. Utilize the [fee parameter calculator](https://docs.google.com/spreadsheets/d/12VIiXHaVECG2RUunDSVJpn67IQp9NHFJqUsma2PndpE/edit) to determine whether your transactions will be cheaper if submitting blobs or if submitting calldata. Chains can follow these steps to switch from
