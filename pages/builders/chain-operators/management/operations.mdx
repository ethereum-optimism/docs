...
Use this tool to get your rollup config from `op-node`. This will only work if your chain is **already** in the [superchain-registry](https://raw.githubusercontent.com/ethereum-optimism/superchain-registry/main/chainList.json) and `op-node` has been updated to pull those changes in from the registry.
