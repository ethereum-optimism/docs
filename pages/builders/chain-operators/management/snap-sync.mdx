...
<Callout type="warning">
  For snap sync, all `op-geth` nodes should be ran with the [`--discovery.port`](/builders/node-operators/management/configuration#discoveryport) exposed to easily find other op-geth nodes to sync from.
