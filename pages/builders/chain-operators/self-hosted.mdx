...
lang: en-US
description: Learn how to start a self-hosted, standard configuration OP Chain.
---
...
<Steps>
  ...
  *   **Preinstalls**: OP Chains come with [preinstalled core contracts](/builders/chain-operators/features/preinstalls), making them usable as soon as a chain is initialized on the OP Stack.
  ...
  {<h3>Lauch Your OP Stack Testnet Chain</h3>}
...
OP Chain contracts, features, and security should be thoroughly tested and debugged before Mainnet launch. Here are available options for OP Chains.
...
<Steps>
  ...
  *   Option 1: Conduct automatic testing using a script: TODO.
  *   Option 2: Conduct manual testing using Metamask. TODO: need link
</Steps>
