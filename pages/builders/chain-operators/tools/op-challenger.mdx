...
<Steps>
  ...
  *   perform moves in games and then claim and resolve things.
  ...
  Chain operators can easily create their grafana dashboard for Dispute Monitor using the following json file: [Download the Dispute Monitor JSON](/public/grafana/dispute-monitor-1718214549035.json).
</Steps>
