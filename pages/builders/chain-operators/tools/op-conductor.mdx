---
title: How to Setup op-conductor
lang: en-US
description: Learn how to setup op-conductor to manage multiple OP Stack sequencers.
---

import { Callout, Steps } from 'nextra/components'

# How to Setup op-conductor

## Overview

The [op-conductor](https://github.com/ethereum-optimism/optimism/tree/develop/op-conductor) 
is an auxiliary service designed to enhance the reliability and availability 
of a sequencer in high-availability setups, thereby minimizing the risks 
associated with single point of failure. It is important to note, however, that 
this design does not incorporate Byzantine fault tolerance. This means it 
operates under the assumption that all participating nodes are honest.
