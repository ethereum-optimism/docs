...
Install `op-deployer` following these steps:
    *   Download the pre-built binary (Recommended), by visiting the latest release from the monorepo's
[release page](https://github.com/ethereum-optimism/optimism/releases)
    * Download the binary for your platform
    * Extract it to a location in your `PATH`
