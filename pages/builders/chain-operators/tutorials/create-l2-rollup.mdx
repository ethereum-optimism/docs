...
You'll be using the L1 smart contracts found in the [`contracts-bedrock` package](https://github.com/ethereum-optimism/optimism/tree/develop/packages/contracts-bedrock) within the [Optimism Monorepo](https://github.com/ethereum-optimism/optimism).
...
Several implementations of the OP Stack consensus client exist, including `op-node` (maintained by Optimism Foundation) and [`magi`](https://github.com/a16z/magi) (maintained by a16z).
In this tutorial you'll be using the [`op-node` implementation](https://github.com/ethereum-optimism/optimism/tree/develop/op-node) found within the [Optimism Monorepo](https://github.com/ethereum-optimism/optimism).
...
You'll be using the [`op-batcher` implementation](https://github.com/ethereum-optimism/optimism/tree/develop/op-batcher) of the Batcher component found within the [Optimism Monorepo](https://github.com/ethereum-optimism/optimism).
...
You'll be using the [`op-proposer` implementation](https://github.com/ethereum-optimism/optimism/tree/develop/op-proposer) of the Proposer component found within the [Optimism Monorepo](https://github.com/ethereum-optimism/optimism).
...
<Steps>
  ...
  It's recommended to keeping this file as-is for now so you don't run into any unexpected errors.
</Steps>
...
*   Checkout the [protocol specs](https://github.com/ethereum-optimism/optimism/tree/develop/specs) for more detail about the rollup protocol.
