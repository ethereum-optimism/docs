...
We recommend using the scripts provided in the monorepo's `package.json` file to install, update, and check for the correct version of foundry. You can do this after you've cloned the monorepo locally.
