...
<Steps>
  ...
  <Callout>
  You will be using the `develop` branch of the Optimism Monorepo for this tutorial.
  You should **NOT** use the `develop` branch in production.
  The latest release approved by Optimism Governance for chains within the [Optimism Superchain](/stack/explainer) is [`v1.1.4`](https://github.com/ethereum-optimism/optimism/tree/v1.1.4).
  </Callout>
