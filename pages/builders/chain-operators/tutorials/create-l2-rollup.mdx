...
You can alternatively also remove the [--p2p.static](/builders/node-operators/configuration/node-config#p2pstatic) option, but you may see failed requests from other chains using the same chain ID.
</Callout>
