...
[Building a custom bridged token](/builders/dapp-developers/tutorials/standard-bridge-custom-token) is often sufficient for projects that need more flexibility.
</Callout>
...
Bridges that extend this interface will be compatibile with the [OP Mainnet Bridge UI](https://app.optimism.io/bridge).
...
The [Superchain Token List](/chain/tokenlist) exists to help users and developers find the right bridged representations of assets native to another blockchain.
