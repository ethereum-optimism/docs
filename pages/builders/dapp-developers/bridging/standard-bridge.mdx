...
<Steps>
  ...
  *   `bytes calldata _extraData`: Optional identify extra data.
  ...
  {<h3>The Standard Bridge burns the transferred astokenssets</h3>}
...
*   [Learn how to bridge ERC-20 tokens with the Optimism SDK](/builders/dapp-developers/tutorials/cross-dom-bridge-erc20)
