...
OP Mainnet is [EVM equivalent](https://medium.com/ethereum-optimism/introducing-evm-equivalence-5c2021deb306) so you can feel confident that your existing Ethereum smart contract skills will carry over to OP Mainnet.
...
<Cards>
  <Card title="Deploying Your First Contract to OP Mainnet" href="/builders/dapp-developers/tutorials/first-contract" icon={<img src="/img/icons/shapes.svg" />} />

  <Card title="Solidity Compatibility on OP Mainnet" href="/builders/dapp-developers/contracts/compatibility" icon={<img src="/img/icons/shapes.svg" />} />

  <Card title="Testing Apps on OP Mainnet" href="/chain/testing/testing-dapps" icon={<img src="/img/icons/shapes.svg" />} />
</Cards>
...
<Cards>
  <Card title="Basics of Bridging on OP Mainnet" href="/builders/dapp-developers/bridging/basics" icon={<img src="/img/icons/shapes.svg" />} />

  <Card title="Sending Data Between L1 and L2" href="/builders/dapp-developers/bridging/messaging" icon={<img src="/img/icons/shapes.svg" />} />

  <Card title="The Standard Bridge" href="/builders/dapp-developers/bridging/standard-bridge" icon={<img src="/img/icons/shapes.svg" />} />
</Cards>
...
| ----------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- | ---------------- |
| [Deploying Your First Contract on OP Mainnet](tutorials/first-contract)                                                 | Learn how to deploy your first contract to OP Mainnet with Remix.                                                            | 🟢 Easy          |
