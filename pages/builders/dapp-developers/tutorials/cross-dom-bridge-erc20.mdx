...
```js file=<rootDir>/public/tutorials/cross-dom-bridge-erc20.cjs#L6 hash=755b77a7ffc7dfdc186f36c37d3d847a
```
...
This will allow the Standard Bridge to pull these tokens out of your account and escrow inside the bridge.
