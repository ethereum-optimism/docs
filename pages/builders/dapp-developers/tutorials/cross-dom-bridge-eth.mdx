...
```js file=<rootDir>/public/tutorials/cross-dom-bridge-eth.js#L8-L11 hash=4f453e218fe6079f35e4e12c5768acaa
```
...
```js file=<rootDir>/public/tutorials/cross-dom-bridge-eth.js#L16-L21 hash=3648c5f76a6ad1042083c54be8acd960
```
