...
```js file=<rootDir>/public/tutorials/cross-dom-solidity.js#L10-L13 hash=4f453e218fe6079f35e4e12c5768acaa
```
...
```js file=<rootDir>/public/tutorials/cross-dom-solidity.js#L15-L20 hash=3648c5f76a6ad1042083c54be8acd960
```
