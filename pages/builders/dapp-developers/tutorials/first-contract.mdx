...
lang: en-US
description: Learn how to write and deploy your first contract on OP Mainnet using the Rainbow browser extension.
---
...
This tutorial uses [Rainbow](https://rainbow.me), a popular browser extension wallet, just to get you started.
Rainbow is also available as a mobile application, but it's typically easier to use the browser extension for development.
If you already have Rainbow installed, you can skip this section.

<Callout>
Browser-based wallets like Rainbow are convenient for development, but they're not always the most secure option.
You should never store large amounts of ETH or ERC-20 tokens in a browser-based wallet.
If you're planning to store a significant amount of ETH or ERC-20 tokens, consider using a hardware wallet instead.
</Callout>

<Steps>

{<h3>Install the Rainbow extension for your browser</h3>}

Head over to [rainbow.me](https://rainbow.me) and click the "Download Rainbow Extension" button.
You'll then be given an option to install the Rainbow extension for your browser.
Select the browser you're using to be taken to the corresponding extension download page.
