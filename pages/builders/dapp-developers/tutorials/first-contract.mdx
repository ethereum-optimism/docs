...
![Screenshot displaying the MetaMask download page](/img/builders/dapp-developers/tutorials/first-contract/mm-install.png)
...
![Screenshot displaying the MetaMask wallet creation page](/img/builders/dapp-developers/tutorials/first-contract/mm-start.png)
...
![Screenshot displaying the MetaMask password creation page](/img/builders/dapp-developers/tutorials/first-contract/mm-password.png)
...
![Screenshot displaying the MetaMask security video page](/img/builders/dapp-developers/tutorials/first-contract/mm-secure.png)
...
![Screenshot displaying the MetaMask recovery phrase page](/img/builders/dapp-developers/tutorials/first-contract/mm-seed.png)
...
![Screenshot displaying the MetaMask recovery phrase confirmation page](/img/builders/dapp-developers/tutorials/first-contract/mm-confirm.png)
...
![Screenshot displaying the network connection website for OP Sepolia](/img/builders/dapp-developers/tutorials/first-contract/net-connect.png)
...
![Screenshot displaying the MetaMask network approval page](/img/builders/dapp-developers/tutorials/first-contract/net-approve.png)
</div>
...
<div className="md-img" style={{height: '600px'}}>
![Screenshot displaying the MetaMask network switching page](/img/builders/dapp-developers/tutorials/first-contract/net-switch.png)
</div>
...
![Screenshot displaying the empty MyFirstContract file](/img/builders/dapp-developers/tutorials/first-contract/remix-empty.png)
...
![Screenshot displaying the remix compilation tab](/img/builders/dapp-developers/tutorials/first-contract/remix-compile.png)
...
![Screenshot displaying the remix deploy tab](/img/builders/dapp-developers/tutorials/first-contract/remix-deploytab.png)
...
![Screenshot displaying the remix environment dropdown](/img/builders/dapp-developers/tutorials/first-contract/remix-network.png)
...
<div className="md-img" style={{height: '600px'}}>
![Screenshot displaying the MetaMask deployment popup](/img/builders/dapp-developers/tutorials/first-contract/remix-deploy.png)
</div>
...
![Screenshot displaying the deployed contract in remix](/img/builders/dapp-developers/tutorials/first-contract/remix-deployed.png)
...
![Screenshot highlighting the setMessage function button](/img/builders/dapp-developers/tutorials/first-contract/remix-setmessage.png)
...
![Screenshot highlighting the message reading function button](/img/builders/dapp-developers/tutorials/first-contract/remix-message.png)
