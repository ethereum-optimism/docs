...
*   Querying information about the current [L1 data fee](/stack/transaction-fees/overview#the-l1-data-fee)
*   And lots more!
...
*   Check out the [Networks and Connection Details page](/chain/op-networks) for links to public RPC endpoints and contract addresses.
