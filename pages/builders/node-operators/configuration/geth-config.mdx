---
title: Additional Configuration for op-geth
lang: en-US
...
# Additional Configuration for `op-geth` (Execution-Layer)
...
This page list additional configuration options for `op-geth`. `op-geth` implements the Execution-Layer, with minimal changes for a secure Ethereum-equivalent application environment. 
