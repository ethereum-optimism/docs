---
title: Canyon Hard Fork Upgrade
lang: en-US
...
The following infomration is how you can prepare your nodes for both the Canyon upgrade and the ProtocolVersions contract.
...
_Note: this configuration path uses the protocol-version functionalities described above._
...
<Callout type="warning">
    The Canyon testnet hard fork (on both Sepolia and Goerli) is scheduled for **November 14th at 17:00:00 UTC 2023**. We suggest doing this by November 7th 2023 for the testnet upgrade, and monitoring the mainnet upgrade dates through governance.
</Callout>
