...
<Callout type="warning">
  ...
  If you want to estimate the cost of a transaction, you can [use the SDK](/builders/dapp-developers/tutorials/sdk-estimate-costs).
</Callout>
...
This method is documented in [the specifications](https://github.com/ethereum-optimism/specs/blob/main/specs/rollup-node.md#output-method-api).
