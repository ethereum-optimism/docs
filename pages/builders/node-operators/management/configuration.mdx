...
You can configure your node using command line options (a.k.a. flags). There are also sub-commands, which can be used to invoke functionality such as the console or blockchain import/export.
