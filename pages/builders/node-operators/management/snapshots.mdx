...
<Callout type="info">
  You can also download the [latest snapshot](https://datadirs.optimism.io/latest/) or access the [data directory](https://datadirs.optimism.io/) to find new snapshots.
</Callout>

| Snapshot Date | Size  | Download Link                                                                                                                                                    | sha256sum                                                                                          |
| ------------- | ----- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| 2024-01-26    | 3.5TB | [Mirror 1](https://datadirs.optimism.io/mainnet-2024-01-26.tar.zst) <br /> [Mirror 2 (torrent)](https://datadirs.optimism.io/mainnet-2024-01-26.tar.zst.torrent) | <span className="shasum">`2d28a245d5bfa9ea471db88c072b10d40660360dacd3b96cadf51686646f7a62`</span> |
