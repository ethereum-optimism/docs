...
<Callout type="info">
  [Fastnode.io](https://fastnode.io/) graciously provides more recent full node snapshots for OP Mainnet. You can find them [here](https://datapoint.fastnode.io/).
  **Please note:** FastNode.io is a 3rd party provider, and Optimism hasn't verified the snapshots.
</Callout>
