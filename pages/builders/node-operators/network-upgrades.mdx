...
Fjord upgrade includes RIP-7212, Brotli channel compression, FastLZ, and gas cost changes.

*   [RIP-7212: Precompile for secp256r1](https://specs.optimism.io/protocol/precompiles.html#P256VERIFY)
*   [Brotli as a channel compression option](https://specs.optimism.io/fjord/exec-engine.html#fees)
...
*   [Fjord chain derivation changes](https://specs.optimism.io/fjord/derivation.html#increasing-max_rlp_bytes_per_channel-and-max_channel_bank_size)
