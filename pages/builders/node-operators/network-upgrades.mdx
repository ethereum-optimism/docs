...
your node to reconcile the chain.
...
| ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- |
| [Fjord](https://specs.optimism.io/protocol/superchain-upgrades.html#fjord)     | TBD                                                                                        | TBD                                                                                                                                     | TBD                                                                                                                                     |
| [Ecotone](https://specs.optimism.io/protocol/superchain-upgrades.html#ecotone) | [TBD](https://gov.optimism.io/t/upgrade-proposal-5-ecotone-network-upgrade/7669)           | Optimistically Thu Mar 14 00:00:01 UTC 2024 (`1710374401`)                                                                              | Wed Feb 21 17:00:00 UTC 2024 (`1708534800`)                                                                                             |
...
### [Fjord](https://specs.optimism.io/protocol/superchain-upgrades.html#fjord)

Name of the next upgrade after Ecotone. Placeholder for development coordination.

### [Ecotone](https://specs.optimism.io/protocol/superchain-upgrades.html#ecotone)
...
### [Canyon](https://specs.optimism.io/protocol/superchain-upgrades.html#canyon)
