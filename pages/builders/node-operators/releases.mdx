...
| ---------- | --------------------------------------------------------------------------- | ------------------------------------------------------------------------------------ |
| OP Mainnet | [v1.7.0](https://github.com/ethereum-optimism/optimism/releases/tag/v1.7.0) | [v1.101308.2](https://github.com/ethereum-optimism/op-geth/releases/tag/v1.101308.2) |
