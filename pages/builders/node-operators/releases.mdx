...
| ---------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------ |
| OP Mainnet | \[v1.7.5][https://github.com/ethereum-optimism/optimism/releases/tag/op-node%2Fv1.7.5](https://github.com/ethereum-optimism/optimism/releases/tag/op-node%2Fv1.7.5)) | [v1.101315.0](https://github.com/ethereum-optimism/op-geth/releases/tag/v1.101315.0) |
| OP Sepolia | \[v1.7.5][https://github.com/ethereum-optimism/optimism/releases/tag/op-node%2Fv1.7.5](https://github.com/ethereum-optimism/optimism/releases/tag/op-node%2Fv1.7.5)) | [v1.101315.0](https://github.com/ethereum-optimism/op-geth/releases/tag/v1.101315.0) |
