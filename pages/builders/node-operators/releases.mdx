...
This page gives information on the off chain node software release infromation.
...
| ---------- | ------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------ |
| OP Mainnet | [v1.7.6](https://github.com/ethereum-optimism/optimism/releases/tag/v1.7.6) | [v1.101315.1](https://github.com/ethereum-optimism/op-geth/releases/tag/v1.101315.1) |
| OP Sepolia | [v1.7.6](https://github.com/ethereum-optimism/optimism/releases/tag/v1.7.6) | [v1.101315.1](https://github.com/ethereum-optimism/op-geth/releases/tag/v1.101315.1) |
