...
Then, complete the following specific steps for chain operators:

1.  Encode and prepare to send an L1 transaction from your `SystemConfigProxy` owner shortly after Ecotone activation. See the guide on [Using Blobs](/builders/chain-operators/management/blobs#determine-scalar-values-for-using-blobs) for more details.
...
2.  Prepare your batcher to be restarted with the updated configuration in advance of the Ecotone activation to submit blobs. See the guide on [Using Blobs](/builders/chain-operators/management/blobs#update-your-batcher-to-post-blobs) for more details.

3.  You will want to do the above steps very shortly after the activation of Ecotone to take full advantage of cheaper fees with 4844.
