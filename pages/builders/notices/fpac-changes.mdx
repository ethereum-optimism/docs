---
title: Preparing for Fault Proof Breaking Changes
lang: en-US
description: Learn how to prepare for Fault Proof Alpha breaking changes.
---

import { Steps, Callout } from 'nextra/components'

# Preparing for Fault Proof Breaking Changes

This page outlines breaking changes related to Fault Proof Alpha Chad upgrade for bridges, centralized exchanges, and custom solutions that use withdrawals. This page outlines changes for OP Mainnet and OP Sepolia only, and details for other OP Chains are forthcoming.
...
<Callout type="warning">
  *   Fault Proof Alpha Chad is scheduled to launch at **1708534800 Tue March 19 17:00:00 UTC 2024**.
...
The proposed Fault Proof upgrade requires developers to enable Fault Proof Mainnet changes before the Sepolia release. This impacts bridges, centralized exchanges, and custom solutions that use withdrawals.
