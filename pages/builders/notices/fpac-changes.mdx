...
### Changes
Viem changes will require replacing the currently used decorator with the `experimental` decorator that supports fault proofs. 
When fault proofs are on Mainnet in the future, `publicActionsL2` will be updated to support fault proofs by default and it will be recommended that developers switch to the stable API.

### Impact
Viem changes will break the API and require both updating to latest version and replacing use of the currently used decorator with the `experimental` decorator that supports fault proofs. Outside of switching the decorators, developers won't notice any changes in client usage.

<Callout type="warning">
Viem version will need to be updated and steps/instructions will be coming soon.
</Callout>
...
<Callout type="warning">
Fault Monitor will need to be updated and steps/instructions will be coming soon.
</Callout>
