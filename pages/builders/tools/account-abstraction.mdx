...
Account Abstraction enables users to utilize smart contracts more easily. While the default account for most users today is an Externally Owned Account (<Reference>EOA</Reference>), smart account adoption has been growing due to their ability to create superior user experiences.
