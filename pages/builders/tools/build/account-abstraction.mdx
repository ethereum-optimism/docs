...
lang: en-US
description: This guide explains how to use account abstraction to remove friction from your dapp experience
---

# Account Abstraction

[ERC-4337](https://www.erc4337.io/docs/paymasters/introduction), also known as Account Abstraction, enables more opportunities for dapps and wallet developers to innovate on user experiences including the ability to:
