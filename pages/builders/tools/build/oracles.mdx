...
API3 is building secure [first-party oracles](https://docs.api3.org/explore/introduction/first-party.html) and [OEV-enabled](https://docs.api3.org/explore/introduction/oracle-extractable-value.html) data feeds on Optimism. The data feeds are continuously updated by first-party oracles using signed data.

Check out the [API3 Market](https://market.api3.org/optimism) to access 150+ dAPIs on Optimism.
...
Apart from data feeds, API3 also provides [Quantum Random Number Generation](https://docs.api3.org/explore/qrng/) on Optimism. QRNG is a free-to-use service that provides quantum randomness on-chain. It is powered by [Airnode](https://docs.api3.org/reference/airnode/latest/understand/), the first-party oracle that is directly operated by the QRNG API providers. Read more about QRNG [here](https://docs.api3.org/reference/qrng/).

Check out these guides on how to:

*   [Using dAPIs on the Market](https://docs.api3.org/guides/dapis/subscribing-to-dapis/)
