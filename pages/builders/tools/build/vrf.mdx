...
- Processing: Gelato VRF fetch the random number from Drand.
- Delivery: The fulfillRandomness function delivers the random number to the requesting contract.

Ready to integrate? Head over the quick start guide [here](https://docs.gelato.network/web3-services/vrf/quick-start)
