...
The paid version of PRC is billed based on usage, allowing developers to have better cost control without the need for monthly subscriptions. For more information, you can visit our [Pricing Model](https://docs.4everland.org/get-started/billing-and-pricing/pricing-model).
