...
### Description and Pricing
dRPC (https://drpc.org) provides geo distributed auto-scalable [OP Mainnet and OP Sepolia nodes] (https://drpc.org/chainlist/optimism). dRPC supports Websocket and all methods, including debug and trace methods. 
