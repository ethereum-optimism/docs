...
lang: en-US
description: Learn how to use decentralized applications to access Optimism-specific services.
---
...
However, there are [a few differences](/chain/differences), which sometimes require decentralized applications to access Optimism-specific services.

## Optimism-Specific Services

*   [Gas costs](/stack/transaction-fees/overview)
*   [Interlayer communication](/builders/dapp-developers/bridging/basics)
...
[Our gas costs](/stack/transaction-fees/overview) are predominately the cost of writing the transaction to L1, which depends on the transaction size, not the amount of processing required.
...
3.  [Offchain, using RPC](/builders/node-operators/json-rpc), which is more complicated but usable from any development stack (Python, Rust, etc.).
...
*   Submit an issue on [Github](https://github.com/ethereum-optimism/optimism/issues).
...
*   [Bridging ETH](/builders/dapp-developers/tutorials/cross-dom-bridge-eth)
*   [Bridging ERC-20](/builders/dapp-developers/tutorials/cross-dom-bridge-erc20)
