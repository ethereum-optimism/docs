...
*   [Gas costs](/stack/transactions/transaction-fees)
...
[Our gas costs](/stack/transactions/transaction-fees) are predominately the cost of writing the transaction to L1, which depends on the transaction size, not the amount of processing required.
...
*   [Viewing transactions between layers](/builders/dapp-developers/tutorials/sdk-view-txns)
