...
[Tenderly](https://tenderly.co/) monitoring stack lets you [inspect any transaction execution on OP Mainnet or OP Sepolia](https://docs.tenderly.co/forks/reference/tenderly-fork-customization-via-api/easily-debug-failed-transactions).
