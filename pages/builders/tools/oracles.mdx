...
This is a push Oracle. Chainlink provides a number of [price feeds](https://docs.chain.link/docs/optimism-price-feeds/).
...
*   Automation: Chainlink Automation is an ultra-reliable and performant smart contract automation solution enabling developers to quickly scale their operations in a verifiable, decentralized, and cost-efficient manner, to build next-generation dApps.
