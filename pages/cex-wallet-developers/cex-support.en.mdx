...
You can choose between our public endpoints, which are rate limited, and endpoints from [infrastructure providers](/op-mainnet/op-networks). Given rate throughput limits, we recommend using a private rpc provider for both mainnet and testnet use cases. 
