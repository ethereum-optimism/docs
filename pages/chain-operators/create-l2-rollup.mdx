...
| [pnpm](https://pnpm.io/installation) | any |
| [foundry](https://github.com/foundry-rs/foundry#installation) | any |
| [make](https://linux.die.net/man/1/make) | any |
| [jq](https://github.com/jqlang/jq) | any |
| [direnv](https://direnv.net) | any |
...
<Callout type="error"> 
You should **not** use the `getting-started-wallets.sh` tool for production deployments.
