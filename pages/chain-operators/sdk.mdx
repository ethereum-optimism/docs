...
If you are using a chain that is *not* natively supported, for example an OP Stack chain [you just created](/op-stack/getting-started), you can continue to use [the OP Stack Client SDK](https://sdk.optimism.io/). 
...
If you followed the directions in [Getting Started](/op-stack/getting-started), the contract addresses are in `.../optimism/packages/contracts-bedrock/deployments/getting-started`, which you created when you deployed the L1 contracts.
