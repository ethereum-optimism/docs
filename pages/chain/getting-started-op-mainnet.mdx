...
To access any Ethereum type network you need an endpoint. [These providers](/builders/tools/rpc-providers) support our networks.
...
After you are done with that development, debug your decentralized application using either a [development node](/chain/testing/dev-node) or the [Goerli test network](/chain/op-networks).
...
You don't have to upload your source code to [block explorers](/builders/tools/block-explorers), but it is a good idea.
