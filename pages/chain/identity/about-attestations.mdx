...
Our journey towards decentralized identity begins with the [Ethereum Attestation Service](https://optimism-goerli-bedrock.easscan.org/), a set of smart contracts for creating, verifying, and revoking on/off-chain attestations.
