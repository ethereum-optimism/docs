...
You can keep up with the roadmap progress in the [Cannon repository](https://github.com/ethereum-optimism/cannon/) for the fault proofs and [Optimism specs repository](https://github.com/ethereum-optimism/optimism/tree/v1.1.4/specs) for the overall protocol work.
