...
Although the fault proof game is permissionless, the Optimism Security Council acting as the [Guardian](/chain/security/priviledged-roles#guardian) role provides a backstop in case of a failure in the fault proof game.
