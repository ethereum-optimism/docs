...
*   L1 Proxy Admin may eventually be operated by a [Security Council](https://optimism.help/Token+House+Governance/Security+Council/Intro+to+Optimism's+Security+Council).
...
*   L2 Proxy Admin may eventually be operated by a [Security Council](https://optimism.help/Token+House+Governance/Security+Council/Intro+to+Optimism's+Security+Council).
...
*   System Config Owner may eventually be operated by a [Security Council](https://optimism.help/Token+House+Governance/Security+Council/Intro+to+Optimism's+Security+Council).
