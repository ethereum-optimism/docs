...
*   You can [modify the blockchain in various ways](../../builders/chain-operators/hacks/overview).
*   Check out the [protocol specs](https://specs.optimism.io/) for more detail about the rollup protocol.
*   If you run into any problems, please visit the [Chain Operators Troubleshooting Guide](../../builders/chain-operators/management/troubleshooting)
