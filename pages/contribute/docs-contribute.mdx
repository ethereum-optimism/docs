...
- [Edit existing content](/contributing/#how-to-update-content): make tweaks to existing content using the ✏️ **Edit this page on Github** or ❤️ **Share general feedback** links on the right-side of any page. 
...
add a new FAQ (question+answer set) to an [existing page](/op-mainnet/security/faq#security-model-faq), create a new FAQ page, or update an existing FAQ question/answer set.
...
add a new troubleshooting item (problem+solution set) to an [existing page](/chain-operators/chain-troubleshooting), create a new troubleshooting page, or update an existing troubleshooting problem/solution set.
...
add a new oracle to the [Oracle page](/tools/oracles) or update an existing oracle.
...
add a new faucet to the [Faucets page](/tools/facuets) or update an existing faucet.
...
add an RPC or Node provider to our [RPC developer tools listing](/tools/rpc-providers).
...
help us continue to expand the Optimism [glossary](/resources/glossary).
...
- [Submit a bug report](https://immunefi.com/bounty/optimism/): create a report to help us improve our products and developer tooling. For more information, please read our [Security Policy](/resources/security-policy).
...
Please see the [Contributing Guide](https://github.com/ethereum-optimism/docs/blob/main/CONTRIBUTING.md) for more details.
...
- Messaging us on [Discord](https://discord.gg/optimism)
...
- our [style guide](/contribute/style-guide)
...
Decisions about individual PRs, tutorials, and major docs updates are made by the Optimism Docs team housed in Developer Relations. 
...
- [devrel@oplabs.co](mailto:devrel@oplabs.co)
- [@OPLabsPBC](https://twitter.com/OPLabsPBC)
- [Discord server](https://discord.gg/optimism)
...
You can reach us on [Discord](https://discord.gg/optimism) or our Developer Support [discussion board](https://github.com/ethereum-optimism/developers/discussions). We look forward to growing the Collective with you!