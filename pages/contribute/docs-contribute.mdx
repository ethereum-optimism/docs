...
- [Edit existing content](/contributing/#how-to-work-on-docsoptimismio): make tweaks to existing content using the ✏️ **Edit this page on Github** or ❤️ **Share general feedback** links on the right-side of any page. 
...
add a new oracle to the [Oracles page](/tools/oracles) or update an existing oracle.
...
add a new faucet to the [Faucets page](/tools/faucets) or update an existing faucet.
