...
lang: en-US
description: This tutorial teaches you how to use the Optimism SDK to transfer ERC-20 tokens between Layer 1 (Ethereum or Goerli) and Layer 2 (OP Mainnet or OP Goerli).
---
...
// see here: 
// https://docs.optimism.io/dapp-developers/bridging/standard-bridge-standard-token
