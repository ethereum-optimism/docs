...
* [Hop](https://app.hop.exchange/#/send?sourceNetwork=ethereum&destNetwork=optimism&token=USDC)
* [Synapse](https://synapseprotocol.com/?inputCurrency=USDC&outputCurrency=USDC&outputChain=10)
