---
title: Communicating between contracts on OP Mainnet and Ethereum Using Solidity
lang: en-US
description: This tutorial teaches you how to use Solidity for interlayer communication between contracts on Ethereum and OP Mainnet.
---
...
The following section shares contract information for `FromL1_ControlL2Greeter.sol` and `FromL2_ControlL1Greeter.sol`.
