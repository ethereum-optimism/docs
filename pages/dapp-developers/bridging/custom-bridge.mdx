...
For details on how cross-domain messaging works, see the [Bridging basics](basics) guide and also the tutorial on [depositing and withdrawing between L1 and L2](cross-dom-bridge-erc20).
