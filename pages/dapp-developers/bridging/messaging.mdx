...
<Callout type="info">
[See here for a step by step tutorial](cross-dom-comm)
</Callout>
...
<Callout type="info">
When using the **messenger contracts**, the [`L1CrossDomainMessenger`](https://github.com/ethereum-optimism/optimism/blob/develop/packages/contracts-bedrock/src/L1/L1CrossDomainMessenger.sol) and [`L2CrossDomainMessenger`](https://github.com/ethereum-optimism/optimism/blob/develop/packages/contracts-bedrock/src/L2/L2CrossDomainMessenger.sol), always come pre-deployed to each of our networks.
...
contract, which then sends a call to the [`CanonicalTransactionChain`](https://github.com/ethereum-optimism/optimism/blob/33741760adce92c8bdf61f693058144bb6986e30/specs/derivation.md#batch-submission-wire-format).
...
1. An L1 transaction that *proves* the transaction.
   ...
   This transaction is expensive because it includes verifying a [Merkle trie](https://docs.optimism.io/resources/glossary#merkle-patricia-trie) inclusion proof.
