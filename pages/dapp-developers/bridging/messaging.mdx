...
For a step-by-step tutorial on how to send data between L1 and L2, check out our [Cross-Domain Communication tutorial](cross-dom-comm).
</Callout>
...
<Callout type="info">
You can find the address of the `L1CrossDomainMessenger` for Ethereum [here](https://github.com/ethereum-optimism/optimism/blob/5c5b58e800de1171ca5ea5cf695f5183a1c358b2/packages/contracts-bedrock/deployments/mainnet/L1CrossDomainMessengerProxy.json#L2) and for Goerli [here](https://github.com/ethereum-optimism/optimism/blob/5c5b58e800de1171ca5ea5cf695f5183a1c358b2/packages/contracts-bedrock/deployments/goerli/L1CrossDomainMessengerProxy.json#L2).
The `L2CrossDomainMessenger` contract is always located at the address [`0x4200000000000000000000000000000000000007`](https://github.com/ethereum-optimism/optimism/blob/5c5b58e800de1171ca5ea5cf695f5183a1c358b2/packages/contracts-bedrock/src/libraries/Predeploys.sol#L11) on OP Mainnet and OP Goerli.
</Callout>
...
Transactions sent from L1 to L2 take **approximately 1-3 minutes** to get from Ethereum to OP Mainnet, or from Goerli to OP Goerli.
...
Transactions sent from L2 to L1 take **approximately 7 days** to get from OP Mainnet to Ethereum, or from OP Goerli to Goerli.
...
4. The transaction is finalized on L1.
   ...
   This period is 7 days on Ethereum and a few seconds on Goerli.
...
1. An L1 transaction that *proves* the transaction.
   ...
   This transaction is expensive because it includes verifying a [Merkle trie](https://eth.wiki/fundamentals/patricia-tree) inclusion proof on L1.
