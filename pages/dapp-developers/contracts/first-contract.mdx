...
<Steps>
  ...
  ### Step 2: Click the Files icon ![icon](/img/op-stack/tutorials/first-contract/remix-files-icon.png) and open **contracts > 1\_Storage.sol**

  ### Step 3: Click the Compiler icon ![icon](/img/op-stack/tutorials/first-contract/remix-compiler-icon.png)

  ### Step 4: Click **Compile 1\_Storage.sol**

  ### Step 5: Click the Run icon ![icon](/img/op-stack/tutorials/first-contract/remix-run-icon.png)
