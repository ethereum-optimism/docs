...
In this guide, you'll learn how to work with OP Mainnet contracts directly from other contracts and how to work with them from the client side.
...
*   Check out the [Networks and Connection Details page](/op-networks) for links to public RPC endpoints and contract addresses.
*   Find the addresses for all networks on the [Contract Addresses](/addresses) page.
...
You can find these addresses on the [Contract Addresses](/addresses) page.
...
`@eth-optimism/contracts-ts` also exports [React hooks](https://wagmi.sh/cli/plugins/react) and [wagmi actions](https://wagmi.sh/react/actions) for interacting with OP Mainnet contracts.
Check out the full [README](https://github.com/ethereum-optimism/optimism/tree/develop/packages/contracts-ts#readme) for more information.
