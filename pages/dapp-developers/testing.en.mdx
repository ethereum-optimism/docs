...
You can find the chainid and supporting information for OP Goerli, our test network, [using these endpoints](/op-mainnet/op-networks).
To obtain ETH and tokens (both ERC-20 and NFT) from faucets, [see here](/tools/faucets).
...
See [this tutorial](/dapp-developers/bridging/cross-dom-bridge-erc20) to see how to use it.
