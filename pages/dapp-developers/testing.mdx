...
You can find the chainid and supporting information for OP Goerli, our test network, [using these endpoints](/op-networks).
...
See [this tutorial](/dapp-developers/tutorials/cross-dom-bridge-erc20) to see how to use it.
