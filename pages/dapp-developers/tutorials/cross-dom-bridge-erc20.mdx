...
While you *could* use [the bridge contracts](../bridging/standard-bridge) directly, a [simple usage error](../bridging/standard-bridge#depositing-erc20s) can cause you to lock tokens in the bridge forever and lose their value.
...
<Steps>
  ...
  *   Edit the file as follows:
  ...
  On the production network, the withdrawals take around a week each because of the [challenge period](../bridging/messaging#understanding-the-challenge-period).
</Steps>
