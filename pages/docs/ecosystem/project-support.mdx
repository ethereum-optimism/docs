...
You will be welcomed by [the following metrics](https://dune.com/optimismfnd/Optimism) 📈📈 (up and to the right!), [a budding community](https://discord-gateway.optimism.io/) 🫂🫂, and some great exclusive todo(make sure this is still mainainted): [Telegram Channels](https://t.me/+Cb7q0a1YqItkZTRk) ⚙️⚙️ for builders.
...
1. Check out our developer documentation on this website
1. Head over to [**#dev-support**](https://discord.com/channels/667044843901681675/887914409207414785) on discord
1. todo(make sure this is still mainainted): Join [this TG group](https://t.me/+Cb7q0a1YqItkZTRk) and ask for help there
...
- Deploy to OP Mainnet (we are [EVM Equivalent](https://medium.com/ethereum-optimism/introducing-evm-equivalence-5c2021deb306), not just EVM compatible so it is very easy to deploy). 
  Check out our todo(update link):[getting started tutorial](https://github.com/ethereum-optimism/optimism-tutorial/tree/main/getting-started) to see how to deploy. We also have todo(update link):[tons of more in-depth tutorials](https://github.com/ethereum-optimism/optimism-tutorial) for bridging and other L2 specific functionality. 
...
- To get reviews in real time from governance delegates go to discord and post about your project in todo(update this link):[#temp-check](https://discord.com/channels/667044843901681675/1011238484373159956).
...
Want to see what we are doing with Retroactive Public Goods? todo(update link):[See here](../governance/retropgf-2.md)
