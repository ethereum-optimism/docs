...
# Bridging ERC20 tokens with the Optimism SDK
...
### Step 5: Copy `.env.example` to `.env` and edit it
   ...
   [Paradigm faucet](https://faucet.paradigm.xyz/) gives ETH on the Goerli network. [Optimism faucet](https://optimismfaucet.xyz/) gives ETH on the OP Goerli network.
</Steps>
