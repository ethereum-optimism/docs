...
<Steps>
### Step 1: Give the L2 bridge an allowance to use the user's token
...
### Step 2: Wait until the root state is published on L1, and then prove the withdrawal
...
### Step 3: Wait the fault challenge period (a short period on Goerli, seven days on the production network) and then finish the withdrawal.
