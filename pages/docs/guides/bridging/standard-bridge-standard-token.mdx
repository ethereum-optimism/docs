...
### Step 3: Edit `.env` to set the deployment parameters:
...
### Step 4: Open the hardhat console.

   ```sh
   yarn hardhat console --network optimism-goerli
   ```

### Step 5: Connect to `OptimismMintableERC20Factory`. 
...
### Step 2: Get the data for `OptimismMintableERC20`
...
### Step 3: Get tokens on L1 (and verify the balance)
...
<Steps>
### Step 1: Import the Optimism SDK

   ```js
   optimismSDK = require("@eth-optimism/sdk")
   ```

### Step 2: Create the cross domain messenger
...
<Steps>
### Step 1: Give the L1 bridge an allowance to use the user's token
...
### Step 2: Check your balances on L1 and L2
...
### Step 2: Prove the withdrawal
- You must wait until the root state is published on L1, and then prove the withdrawal.
...
### Step 3: Wait the fault challenge period and finish the withdrawal
- You cannot finish the withdrawal until the fault challenge period has ended.
...
### Step 4: Check your balances on L1 and L2
