...
You can find the chainid and supporting information for OP Goerli, our test network, todo(update internal link):[using these endpoints](../useful-tools/networks.md).
To obtain ETH and tokens (both ERC-20 and NFT) from faucets, todo(update internal link):[see here](../useful-tools/faucets.md).
