...
But a few differences [do exist](/differences).

## OP Mainnet and OP Goerli Endpoint URLs

To access any Ethereum type network you need an endpoint. [These providers](/tools/rpc-providers) support our networks.
...
If you need ETH on OP Goerli for testing purposes, [you can use this faucet](https://app.optimism.io/faucet?utm_source=docs).

## Interacting with Contracts on OP Mainnet or OP Goerli

We have Hardhat's Greeter contract on OP Goerli at address [0x575E9B4f2c3945d7CF07cb76628d29DF471692B8](https://goerli-explorer.optimism.io/address/0x575E9B4f2c3945d7CF07cb76628d29DF471692B8).
...
After you are done with that development, debug your decentralized application using either a [development node](/testing/dev-node) or the [Goerli test network](/op-networks).
