...
If you'd like to learn more about the current state of the OP Stack, check out the page describing the [Bedrock release](bedrock/overview).

The OP Stack of today was built to support [the Optimism Superchain](explainer), a proposed network of L2s that share security, communication layers, and a common development stack (the OP Stack itself).
...
If you're interested in experimenting with the OP Stack, check out [the OP Stack Hacks section of this site](hacks/overview).
...
*   If you’re interested in understanding the OP Stack in more depth, start with the [Design Principles](protocol/design-principles) and [Landscape Overview](landscape).
