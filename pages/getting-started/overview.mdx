...
You might also want to check out our guides for [running a local development environment](./build/dev-node.md) or [running your own OP Mainnet node](/getting-started/run-a-node.md).
...
If you want to bridge a token from Ethereum to OP Mainnet (or vice versa!), you should learn more about our [Standard Token Bridge](/guides/bridging/standard-bridge.md).
