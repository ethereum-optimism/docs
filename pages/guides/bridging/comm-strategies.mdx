...
If you want to do something that relies on the L2 state prior to that point, you should [run a replica](/getting-started/qs-run-node) yourself to make sure the state you use is correct.
