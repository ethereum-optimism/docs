...
You can find the chainid and supporting information for OP Goerli, our test network, todo:[using these endpoints](/op-stack/op-networks).
...
See [this tutorial](/guides/bridging/cross-dom-bridge-erc20) to see how to use it.
