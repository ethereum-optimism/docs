...
If you're a bit more familiar with OP  and Ethereum, you can try walking through one of the various [tutorials](/getting-started/tutorials) put together by the Optimism community.
They'll help you get a headstart when building your first Optimistic project.

If you need testnet ETH, you can use our [Superchain Faucet](https://app.optimism.io/faucet) or check out these other [network faucets](/tools/faucets) options.
...
For example, we have guides for adding OP Mainnet support to a [wallet](/guides/wallet-developers/overview) or a [CEX](/guides/centralized-exchanges/overview).
We also have guides for getting your [token onto the standard bridge](/bridging/standard-bridge-standard-token) or even [writing your own custom bridge](/bridging/custom-bridge).
