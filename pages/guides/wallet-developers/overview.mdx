...
You can choose to connect to OP Mainnet via our rate-limited public endpoints, [private endpoints from infrastructure providers](/op-stack/op-networks), or [by running your own node](/getting-started/qs-run-node).
