---
title: Build Decentralized Identity Apps with Attestations
lang: en-US
...
Our journey towards decentralized identity begins with the [Ethereum Attestation Service](https://optimism-goerli.easscan.org/), a set of smart contracts for creating, verifying, and revoking on/off-chain attestations. 
...
![attestation logo](public/img/op-mainnet/identity/atst-logo.png)
