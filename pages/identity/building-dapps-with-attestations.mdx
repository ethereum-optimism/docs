...
# Building Decentralized Identity Apps with Attestations
...
![Logo](public/img/op-mainnet/identity/atst-logo.png)
...
- **Permissionless Access**: The AttestationStation is a public contract, which means that it is not owned or controlled by any one person or organization. 
  Anyone can use the contract to verify and attest anything.
- **Out-of-the-box Tooling:** Indexing, various access-management integrations, and more are already available for the AttestationStation.
