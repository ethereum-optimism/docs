...
## Next Steps
Attestations serve as a key component in achieving the vision of decentralized identity. For more information, see [About attestations](about-attestations).
