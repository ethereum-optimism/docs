...
## Next Steps
Attestations serve as a key component in achieving the vision of decentralized identity. For more information, see [Build Decentralized Identity Apps with Attestations](building-dapps-with-attestations).
