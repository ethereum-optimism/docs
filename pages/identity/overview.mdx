...
Decentralized identity solutions empower individuals to customize their onchain identity according to their preferences, move it seamlessly across services, and regain control of their personal information from centralized platforms. 
...
In addition to democratic governance, decentralized identity has the potential to expand the design space for innovation of financial products and gives individuals greater control over how their data is used, enabling them to participate in the global economy on their own terms.
...
Through this process, anyone can use algorithms like [EigenTrust](https://en.wikipedia.org/wiki/EigenTrust) to derive identity sets based on a **consensus driven / community-defined / modular** web of trust.  This allows for the establishment of a more trustworthy and reliable means of verifying an individual’s identity in a decentralized environment.
