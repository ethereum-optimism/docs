...
Welcome to the Optimism Docs, where you'll find everything you need to know about the Optimism tech stack, including [OP Mainnet](/chain/getting-started), the [OP Stack](/stack/getting-started), the [Optimism Superchain](/stack/explainer), and more.
...
<Cards>
  ...
  <Card title="Scaffold-OP" href="/builders/dapp-developers/quick-start" icon={<img src="img/icons/gear.svg" />} />

  <Card title="Open Source Repo" href="/builders/dapp-developers/code-examples/ecosystem-overview" icon={<img src="img/icons/gear.svg" />} />
</Cards>
