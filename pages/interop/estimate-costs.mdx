...
<Callout type="info" heading="xxx">
  At writing (May 2025) the cost of a hundred interop messages is just a few cents.
...
This is encoded in a [five member structure](https://github.com/ethereum-optimism/optimism/blob/develop/packages/contracts-bedrock/src/L2/CrossL2Inbox.sol#L7-L19), so *32×5=128* bytes.
...
At writing, each of gas units costs approximately $*3×10<sup>-9</sup>*, so it would take about thirty messages to add up to a full cent.
