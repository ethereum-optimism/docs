...
For more information on how it works, [see the explainer](/concepts/interoperability/superchain-erc20).
...
*   Use the [SuperchainERC20 Starter Kit](/app-developers/quickstarts/token-starter-kit) to deploy an `SuperchainERC20` token on the devnet.
...
<Steps>
  ...
  Here are the required changes to deploy it to the [Interop devnet](/app-developers/tools/testing/devnet).
