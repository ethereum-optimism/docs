...
<Steps>
  ...
  6.  Create `src/GreetingSender.sol`.
      ...
      ```solidity file=<rootDir>/public/tutorials/GreetingSender.sol hash=75d197d1e1da112421785c2160f6a55a
      ```
...
<Steps>
  ...
  2.  Create or replace `src/app.mts` with this code.
      ...
      ```typescript file=<rootDir>/public/tutorials/app.mts hash=caec4e94c5ece6ff3841f2f5f3d17aae
      ```
  ...
  1.  Replace `src/app.mts` with:
      ...
      ```typescript file=<rootDir>/public/tutorials/app_v2.mts hash=5b31a6d32c1a033531a90c8a18807ad7
      ```

  <details>
    <summary>Explanation</summary>

    ```typescript file=<rootDir>/public/tutorials/app_v2.mts#L9-L10 hash=2d062eb374989a8a40199a4d7dc8be6e
    ```

    Import from the [`@eth-optimism/viem`](https://www.npmjs.com/package/@eth-optimism/viem) package.

    ```typescript file=<rootDir>/public/tutorials/app_v2.mts#L17-L31 hash=cf5ce47bcbcd80327230a6da689688f8
    ```
    ...
    ```typescript file=<rootDir>/public/tutorials/app_v2.mts#L54 hash=23aa6f24baeb5757130361f30c1b0e9c
    ```
    ...
    ```typescript file=<rootDir>/public/tutorials/app_v2.mts#L56-L59 hash=8cc99e67ee36474c81183108531cb295
    ```
    ...
    ```typescript file=<rootDir>/public/tutorials/app_v2.mts#L60-L67 hash=b7ed7d70ba5ec84322beee5369c5bee5
    ```
