...
<Steps>
  ...
  1.  If you are using Supersim, setup the [SuperERC20 Starter Kit](/app-developers/starter-kit#setup).
...
*/}
  ...
  ### Transfer tokens using the conmand line
  ...
  3.  Run the TypeScript program, and see the change in your token balances.
