...
*   If you can upgrade the existing contract, but the address is not available on other chains? In that case, [use a custom bridge](upgrade-to-superchain-erc20/custom-bridge).
