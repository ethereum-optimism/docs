...
<Steps>
  ...
  So, to begin, we send an attestation to one of the chains.
  ...
  1.  Create a file, `verify-attestation.mjs`.
      ...
      <details>
        ...
        We need to distinguish between this situation and the situation where the log entry does not exist.
  ...
  Follow the steps below to build this.
