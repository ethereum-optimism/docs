...
<Steps>
  ...
  6.  Create a file, `onchain-verification.mjs`.
      ...
      <details>
        ...
        ```javascript file=<rootDir>/public/tutorials/onchain-verification.mjsL11-L18 hash=0a71974948ba96b474d602a703ae7466 
        ```

        Read the ABI for `Verifier` we created onchain.

        ```javascript file=<rootDir>/public/tutorials/onchain-verification.mjsL57-L74 hash=0a71974948ba96b474d602a703ae7466 
        ```

        Call `Verifier` with the information needed to verify the attestation.

        ```javascript file=<rootDir>/public/tutorials/onchain-verification.mjsLL76 hash=0a71974948ba96b474d602a703ae7466 
        ```
  ...
  10. Modify the name in line 73 and see that false attestations don't get verified.
