...
To demonstrate this functionality, this guide uses an [attestation](https://attest.org/) from one chain in another.
...
<Steps>
  ...
  3.  Create `src/Verifier.sol`.
      ...
      <details>
        ...
        Here you would do anything that requires the attestation to have been verified.
