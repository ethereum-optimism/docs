...
If you’re interested in learning more about the latest *production* release of the OP Stack, the components of the stack that are highly tested and ready for real-world action, check out the page about the [Bedrock Release](bedrock/overview).
...
![The OP Stack layers](public/img/op-stack/protocol/landscape.png)
...
*   [Specifications](https://github.com/ethereum-optimism/optimism/blob/129032f15b76b0d2a940443a39433de931a97a44/specs/withdrawals.md) (called [withdrawal transactions](/dapp-developers/bridging/messaging))
