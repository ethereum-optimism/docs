...
- Follow this tutorial if you'd like to run your node on [OP Mainnet](mainnet).
- Follow this tutorial instead, if you'd like to run your node on [OP Testnet/Sepolia](testnet).