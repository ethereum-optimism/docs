...
`op-geth` and `op-node` are available as Docker images. Consult the [documentation](/op-networks) for the network you are participating in to get the correct image tag.
