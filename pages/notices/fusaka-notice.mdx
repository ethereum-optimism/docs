...
| `op-batcher`    | v1.16.0-rc.1                                                                                          |                                                                                                                                                  | `OP_BATCHER_TXMGR_ENABLE_CELL_PROOFS`: `true` or equivalent CLI flag needs to be set and the batcher restarted just after Fusaka activates on L1. See [the release notes](https://github.com/ethereum-optimism/optimism/releases)For the `op-challenger` l1 flag. |
| `op-node`       | v1.14.0-rc.3                                                                                          | l1 chain config must be supplied via a new flag. Not necessary for chains deriving from Ethereum Mainnet, Sepolia or Hoodi.                      |                                                                                                                                                                                                                                                                   |
| `op-geth`       | [v1.101603.1-rc.1](https://github.com/ethereum-optimism/op-geth/releases/tag/v1.101603.1-rc.1)        |                                                                                                                                                  |                                                                                                                                                                                                                                                                   |
| `op-challenger` | [v1.6.0-rc.3](https://github.com/ethereum-optimism/optimism/releases/tag/op-challenger%2Fv1.6.0-rc.3) | If deploying to a custom l1, must supply OP\_CHALLENGER\_L1\_GENESIS. Not necessary for chains deriving from Ethereum Mainnet, Sepolia or Hoodi. |                                                                                                                                                                                                                                                                   |
|                 |                                                                                                       |                                                                                                                                                  |                                                                                                                                                                                                                                                                   |
