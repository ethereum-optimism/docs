...
Here's the table with "kona-proof" removed:
...
| `op-batcher`    | v1.16.0-rc.1                                                                                          | `OP_BATCHER_TXMGR_ENABLE_CELL_PROOFS`: `true` or equivalent CLI flag needs to be set and the batcher restarted just after Fusaka activates on L1. See [the release notes](https://github.com/ethereum-optimism/optimism/releases)For the `op-batcher` l1 flag. |
| `op-node`       | v1.14.0-rc.3                                                                                          | l1 chain config must be supplied [via a new flag](https://github.com/ethereum-optimism/optimism/releases). Not necessary for chains deriving from Ethereum Mainnet, Sepolia or Hoodi.                                                                          |
...
| `kona-node`     | [v1.1.0-rc.3](https://github.com/op-rs/kona/releases/tag/kona-node%2Fv1.1.0-rc.3)                     |                                                                                                                                                                                                                                                                |
