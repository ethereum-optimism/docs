...
| `op-challenger`                                                                                                                      | [v1.6.0-rc.3](https://github.com/ethereum-optimism/optimism/releases/tag/op-challenger%2Fv1.6.0-rc.3) | If deploying to a custom l1, must supply OP_CHALLENGER_L1_GENESIS. Not necessary for chains deriving from Ethereum Mainnet, Sepolia or Hoodi.                                                                                                                                               |
| |                                                                                                       |                                                                                                                                                |
