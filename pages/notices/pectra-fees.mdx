...
Please review your Ecotone scalar chain configuration stored in the SystemConfig. If your chain uses a zero blob fee scalar, meaning it's configured to price for calldata only, you may need to update it. Otherwise, no action is necessary.
