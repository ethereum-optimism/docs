...
*   Public messaging on OP social channels will begin next week
*   Bridge infrastructure contributors will post banners notifying users of the changes
*   Developer support teams will be prepared for support tickets about transactions that need to be reproven
