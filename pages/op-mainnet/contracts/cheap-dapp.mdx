# Optimizing Contracts for Cheaper Dapps
...
To view the current gas costs as a user, [see here](https://optimism.io/gas-tracker). To retrieve them programatically, [see here](/tools/javascript/sdk-estimate-gas).

For a more in depth look at how transaction fees are calculated see our [fee documentation](/op-stack/transaction-fees/overview).
