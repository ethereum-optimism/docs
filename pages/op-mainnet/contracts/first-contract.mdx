...
If you are already familiar with Solidity, go to the [getting started guide](/getting-started) for a tutorial that teaches you only how to use OP Mainnet and OP Goerli with the tools you already know.
...
### Step 2: Click the Files icon ![icon](public/docs/op-stack/tutorials/first-contract/remix-files-icon.png) and open **contracts > 1_Storage.sol**

### Step 3: Click the Compiler icon ![icon](public/docs/op-stack/tutorials/first-contract/remix-compiler-icon.png) 

### Step 4: Click **Compile 1_Storage.sol**

### Step 5: Click the Run icon ![icon](public/docs/op-stack/tutorials/first-contract/remix-run-icon.png)
...
### Step 11: See the retrieved number right below the **retrieve** button
   ...
   ![icon](public/docs/op-stack/tutorials/first-contract/remix-query.png)
...
- Because this is a transaction that affects the blockchain state it costs ETH and requires you to **Confirm** on MetaMask.   
   ...
   ![icon](public/docs/op-stack/tutorials/first-contract/remix-tx.png)
...
- In the Remix console (bottom right quadrant of the window), expand the bottom entry to see the transaction information
   ...
   ![icon](public/docs/op-stack/tutorials/first-contract/remix-console.png)
...
- Back in Remix, click **retrieve** again to see that the value has changed.
   ...
   ![icon](public/docs/op-stack/tutorials/first-contract/remix-query-2.png)
</Steps>
