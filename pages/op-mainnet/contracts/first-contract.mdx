...
### Step 2: Click the Files icon (<img src="/assets/remix-files-icon.png" height="24" valign="top" />) and open **contracts > 1_Storage.sol**

### Step 3: Click the Compiler icon (<img src="/assets/remix-compiler-icon.png" height="24" valign="top" />) 

### Step 4: Click **Compile 1_Storage.sol**

### Step 5: Click the Run icon (<img src="/assets/remix-run-icon.png" height="24" valign="top" />)
