...
- Querying information about the current [L1 data fee](/op-stack/transaction-fees/overview#the-l1-data-fee)
- And lots more!
...
Check out the [Networks and Connection Details page](/op-mainnet/op-networks) for links to the contract addresses for each network.
