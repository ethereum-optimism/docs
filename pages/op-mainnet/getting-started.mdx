...
### Step 4: Click the run icon ![icon](public/docs/op-stack/tutorials/getting-started/remix-run-icon.png)
...
<Steps>
### Step 1: Click the run icon ![icon](public/docs/op-stack/tutorials/getting-started/remix-run-icon.png)

### Step 2: Make sure your environment is **Injected Web3** and the network ID is **420**

   ![icon](public/docs/op-stack/tutorials/getting-started/remix-env.png)

### Step 3: Click the files icon ![icon](public/docs/op-stack/tutorials/getting-started/remix-files-icon.png)

### Step 4: Download [Greeter.sol](hardhat/contracts/Greeter.sol) and upload ![icon](public/docs/op-stack/tutorials/getting-started/remix-upload-icon.png) it to Remix under **contracts**
...
### Step 7: Click the run icon ![icon](public/docs/op-stack/tutorials/getting-started/remix-run-icon.png)
...
### Step 8: Scroll down
   ...
   ![icon](public/docs/op-stack/tutorials/getting-started/remix-connect.png)

### Step 9: Click **greet** and expand the transaction result in the console (bottom right)

   ![icon](public/docs/op-stack/tutorials/getting-started/remix-query.png)
...
- Note that if the greeting includes a comma, you need to enclose it in quotes.
   ...
   ![icon](public/docs/op-stack/tutorials/getting-started/remix-tx.png)
...
### Step 2: Click **Deploy**
   ...
   ![icon](public/docs/op-stack/tutorials/getting-started/remix-deploy.png)
...
After you are done with that development, debug your decentralized application using either a [development node](/op-mainnet/testing/dev-node) or the [Goerli test network](/op-stack/op-networks). 
...
You don't have to upload your source code to [block explorers](/tools/monitoring/block-explorers), but it is a good idea. 
