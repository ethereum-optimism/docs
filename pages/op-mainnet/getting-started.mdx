...
### Step 4: Click the run icon ![icon](public/img/op-stack/tutorials/getting-started/remix-run-icon.png)
...
<Steps>
### Step 1: Click the run icon ![icon](public/img/op-stack/tutorials/getting-started/remix-run-icon.png)

### Step 2: Make sure your environment is **Injected Web3** and the network ID is **420**

   ![icon](public/img/op-stack/tutorials/getting-started/remix-env.png)

### Step 3: Click the files icon ![icon](public/img/op-stack/tutorials/getting-started/remix-files-icon.png)

### Step 4: Download [Greeter.sol](hardhat/contracts/Greeter.sol) and upload ![icon](public/img/op-stack/tutorials/getting-started/remix-upload-icon.png) it to Remix under **contracts**
...
### Step 7: Click the run icon ![icon](public/img/op-stack/tutorials/getting-started/remix-run-icon.png)
...
### Step 8: Scroll down
   ...
   ![icon](public/img/op-stack/tutorials/getting-started/remix-connect.png)

### Step 9: Click **greet** and expand the transaction result in the console (bottom right)

   ![icon](public/img/op-stack/tutorials/getting-started/remix-query.png)
...
- Note that if the greeting includes a comma, you need to enclose it in quotes.
   ...
   ![icon](public/img/op-stack/tutorials/getting-started/remix-tx.png)
...
### Step 2: Click **Deploy**
   ...
   ![icon](public/img/op-stack/tutorials/getting-started/remix-deploy.png)
