...
[Here is the tutorial](/op-mainnet/identity/building-dapps-with-attestations)
...
- This version of AttestationStation is now deprecated.
- Please see Ethereum Attestation Service.