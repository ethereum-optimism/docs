...
If you already have Sepolia ETH, you can deposit it by sending it to the Optimism Portal on L1 Sepolia (`0x16Fc5058F25648194471939df75CF27A2fdC48BC`) or use the [Bridge UI](https://app.optimism.io/bridge). Alternatively, to get L2 Sepolia ETH check out the faucet options in [Network Faucets](/tools/faucets).
