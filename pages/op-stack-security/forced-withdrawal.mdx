...
<Steps>
  ...
  ### Create the object for the L1 contracts, as explained in [the documentation](/tools/javascript/sdk)
  ...
  This step, and subsequent ETH withdrawal steps, are explained in [this tutorial](/dapp-developers/tutorials/cross-dom-bridge-eth).
