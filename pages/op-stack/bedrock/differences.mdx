...
# Differences between Bedrock and L1 Ethereum
...
[By default, transaction costs on OP Stack chains](/guides/transaction-fees/overview) include an [L2 execution fee](/guides/transaction-fees/overview#the-l2-execution-fee) and an [L1 data fee](/guides/transaction-fees/overview#the-l1-data-fee). 
