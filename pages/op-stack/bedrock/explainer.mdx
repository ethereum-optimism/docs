...
For a deep dive into the differences between Bedrock and previous versions of the protocol, see the [How is Bedrock Different?](/op-stack/bedrock/differences) page.