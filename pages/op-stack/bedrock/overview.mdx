...
Learn about the basics of the Rollup protocol used by Bedrock on the [Rollup Protocol](/op-stack/protocol/overview) page.

### Bedrock Explainer

Learn all about the Bedrock release of the OP Stack by reading the [Bedrock Explainer](explainer).
