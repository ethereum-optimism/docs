...
In OP Mainnet (and most other OP Stack chain) transaction fees include both an [L1 data fee](/guides/transaction-fees#estimating-the-l1-data-fee) and an [L2 execution fee](/guides/transaction-fees#the-l2-execution-fee). 
To display the entire estimated cost of a transaction to your users we recommend you [use the SDK](/tools/javascript/sdk-estimate-gas) or [@eth-optimism/fee-estimation](https://github.com/ethereum-optimism/optimism/tree/develop/packages/fee-estimation) if you need to optimize for JS performance. 
