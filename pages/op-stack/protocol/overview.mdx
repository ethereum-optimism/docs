...
This is important because writing to L1 is [the major cost of OP Mainnet transactions](/guides/transaction-fees/overview).
...
See the [developer documentation and examples](/guides/bridging/standard-bridge) on details on the inner workings of the Standard bridge.
...
You use [`L1CrossDomainMessenger`](/guides/bridging/cross-dom-comm) or [`L1StandardBridge`](https://github.com/ethereum-optimism/optimism/blob/develop/packages/contracts-bedrock/contracts/L1/L1StandardBridge.sol).
