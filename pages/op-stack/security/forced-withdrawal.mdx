...
The code to go along with this article is available [within our tutorials](/getting-started/tutorials).
<Steps>

//need to update with new tutorial stuff
### Step 1: Clone the repository, move to the correct directory, and install the required dependencies.
...
### Step 2: Copy the environment setup variables.
...
### Step 8: Create [a cross domain messenger](https://sdk.optimism.io/classes/crosschainmessenger).
   This step, and subsequent ETH withdrawal steps, are explained in [this tutorial](/guides/bridging/cross-dom-bridge-eth).
