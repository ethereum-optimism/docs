...
Use `op-challenger` subcommands to interact with the Fault Proof System for testing and debugging purposes:
...
# List claims in a specific game
./op-challenger/bin/op-challenger list-claims \
  --l1-eth-rpc=$L1_RPC_URL \
  --game-address=0xGAME_ADDRESS
```
