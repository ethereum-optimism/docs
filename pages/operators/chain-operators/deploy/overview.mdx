...
*   Discover how to [deploy the smart contracts](/chain-operators/guides/deployment/contracts).
*   Find out how to create your [genesis file](/operators/chain-operators/deploy/genesis).
*   Explore some chain operator [best practices](/chain-operators/guides/best-practices).
