...
*   Complete deployment of L1 smart contracts using [op-deployer](/chain-operators/guides/deployment/contracts).
...
*   If you plan to join the Superchain, follow the [Standard Rollup Charter](/governance/blockspace-charter).
*   Configure [monitoring and maintenance](/chain-operators/tools/monitoring)
*   Read the [op-deployer docs](/chain-operators/tools/op-deployer)
