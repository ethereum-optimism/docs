...
lang: en-US
description: Learn how to modify the default Derivation layer module for an OP Stack chain.
---
...
[Tutorial: Adding attributes to the derivation function](/operators/chain-operators/tutorials/adding-derivation-attributes).
