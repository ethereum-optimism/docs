...
lang: en-US
description: Learn how to modify the default Execution Layer module for an OP Stack chain.
---
...
[Tutorial: Adding a precompile](/operators/chain-operators/tutorials/adding-precompiles).
