...
<Steps>
  ...
  <Callout type="warning">
  Since the Pectra upgrade on L1, chains which exclusively use calldata DA need to scale up their BaseFeeScalar by 16/10. See [this notice](../../notices/pectra-fees.mdx).
  </Callout>
