...
There are certain [privileged roles](/stack/chain/security/privileged-roles) that 
...
<Callout type="info">
  Refer to the [privileged roles](/stack/chain/security/privileged-roles) documentation
