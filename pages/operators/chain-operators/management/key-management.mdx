...
There are certain [privileged roles](/chain-operators/reference/privileged-roles) that 
...
<Callout type="info">
  Refer to the [privileged roles](/chain-operators/reference/privileged-roles) documentation
