...
* `file://` - Points to a local file containing the contract artifacts
* `http://` or `https://` - Retrieves contract artifacts from a remote URL
...
l1ContractsLocator = "file:///path/to/local/contracts"
l2ContractsLocator = "https://example.com/path/to/contracts"
```
