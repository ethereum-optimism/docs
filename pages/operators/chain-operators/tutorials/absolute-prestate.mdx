...
description: A guide for chain operators on how to generate the absolute prestate and preimage files necessary for running cannon/permissionless proofs.
lang: en-US
...
This guide will show chain operators how to generate the absolute prestate and preimage files necessary for running cannon/permissionless proofs.
...
<Steps>
  ...
  cd optimism
  git checkout op-program/v1.6.0-rc.2  # Use the latest tagged version
