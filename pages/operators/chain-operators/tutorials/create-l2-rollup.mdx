...
read the [deployment overview page](/chain-operators/guides/deployment/overview). 
...
1.  **Deploy the L1 contracts** using [op-deployer](/chain-operators/tools/op-deployer).
...
*   If you run into any problems, please visit the [Chain Operators Troubleshooting Guide](/chain-operators/guides/troubleshooting) for help.
