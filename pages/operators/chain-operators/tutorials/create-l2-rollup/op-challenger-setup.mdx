...
<Steps>
  ...
  *   L1 contracts [deployed with dispute game factory](/operators/chain-operators/tutorials/dispute-games)
  ...
  *   `genesis-l2.json` - L2 genesis file from the `op-deployer` guide
</Steps>
