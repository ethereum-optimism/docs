...
<Callout type="info">
  **Step 5 of 5**: This tutorial is designed to be followed step-by-step. Each step builds on the previous one.
</Callout>
...
The L1StandardBridge address is part of your deployment artifacts. You can find it in two ways:

1. Check your deployment configuration output after running the deployer
2. Use the Contract Addresses page in your chain's documentation
