...
<Tabs items={['Build from source (Recommended)', 'Download pre-built binary']}>
  <Tabs.Tab>
...
Great! You've completed the setup and have op-deployer installed and ready. Since op-deployer handles L1 smart contract deployment automatically, you can now move on to setting up the execution layer.

<Card title="Spin up sequencer →" href="./op-geth-setup">
  **Next**: Set up and run op-geth and op-node, the execution and consensus layers for your rollup.
</Card>
