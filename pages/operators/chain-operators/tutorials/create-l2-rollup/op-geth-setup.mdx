...
<Steps>
  ### Successful L1 contract deployment

  *   Deployed L1 contracts using [`op-deployer apply`](/operators/chain-operators/tutorials/create-l2-rollup/op-deployer-setup#apply-deploy-your-chain) command.
