...
<Callout type="info">
  ...
  According to the **op-node v1.13.3** [release notes](https://github.com/ethereum-optimism/optimism/releases), this op-node version specifically corresponds to **op-geth v1.101511.1**.
...
<Tabs items={['Build from source', 'Using docker']}>
  ...
  <Tabs.Tab>
    ...
    **Important**: Replace ALL placeholder values (`YOUR_ACTUAL_*`) with your real configuration values.
    ...
    5.  **Initialize op-geth with Docker:**
