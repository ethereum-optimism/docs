...
*   Your chain is running OP Contracts version 2.0.0 or higher
*   You have access to the chain's `ProxyAdmin`
*   You have the forge toolkit installed for executing calls
...
Most chains initially deploy with only the permissioned dispute game. This guide explains how to add the permissionless game.
...
2.  Optionally deploys a new `DelayedWETH` contract
...
*   systemConfig: Address of your chain's [`SystemConfig`](https://github.com/ethereum-optimism/optimism/blob/6dc586d551f55b2b3a607cfcca9d3d272dec84d7/packages/contracts-bedrock/src/L1/SystemConfig.sol) contract
*   proxyAdmin: Address of your chain's [`ProxyAdmin`](https://github.com/ethereum-optimism/optimism/blob/6dc586d551f55b2b3a607cfcca9d3d272dec84d7/packages/contracts-bedrock/src/universal/ProxyAdmin.sol) contract
*   delayedWETH: Address of the [`DelayedWETH`](https://github.com/ethereum-optimism/optimism/blob/6dc586d551f55b2b3a607cfcca9d3d272dec84d7/packages/contracts-bedrock/src/dispute/DelayedWETH.sol) contract (use zero address to deploy a new one)
...
4.  Setting the respected game type
    ...
    For detailed instructions on setting the respected game type and migrating your chain from permissioned to permissionless fault proofs, refer to the [Todo: Update this once it goes live- Migrating to permissionless fault proofs guide](https://deploy-preview-1539--docs-optimism.netlify.app/operators/chain-operators/tutorials/migrating-permissionless).
