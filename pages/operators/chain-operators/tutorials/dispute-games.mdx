...
*   You have the [forge toolkit installed](https://book.getfoundry.sh/getting-started/installation) for executing calls
...
*   For more detail on migrating to permissionless fault proofs, [see the docs](/operators/chain-operators/tutorials/migrating-permissionless).
