...
*   Deploying and configuring smart contracts using OP Stack chain manager (OPCM)
...
The (OPCM) is the recommended tool for safely managing OP Stack upgrades:
...
For detailed information about privileged roles and their security implications, refer to the [Privileged Roles Documentation](https://docs.optimism.io/chain/security/privileged-roles).
