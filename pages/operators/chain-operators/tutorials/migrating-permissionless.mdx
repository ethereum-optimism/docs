...
For detailed information about privileged roles and their security implications, refer to the [privileged roles documentation](/chain/security/privileged-roles).
...
*   [Optimism Fault Proof Documentation](/builders/chain-operators/tools/op-challenger)
*   [Privileged Roles Documentation](/chain/security/privileged-roles)
