...
## Next steps
*   See the [op-node configuration](/node-operators/guides/configuration/consensus) guide for additional configuration options for `op-node` and the Consensus-Layer.
*   Similarly, visit the [op-geth configuration](/node-operators/guides/configuration/execution) guide for additional configuration options for `op-geth` and Execution-Layer.
