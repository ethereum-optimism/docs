...
*   To check for the latest node software, see the [Software Releases](/node-operators/reference/releases).
*   For more information on the governance process see the [governance documentation](https://community.optimism.io/docs/governance/?utm_source=op-docs\&utm_medium=docs).
