...
<Steps>
  ...
  *   Configure your execution client:
      ...
      *   For `op-nethermind`: Use the [base configuration](/operators/node-operators/configuration/base-config#working-base-configuration-nethermind) and set the [recommended flags](/operators/node-operators/configuration/base-config#recommended-flags-for-op-nethermind-configuration)
