...
Although less flexible than [running a node from source](/node-operators/tutorials/source-node) or building your own Docker setup, this is a great way to quickly get started with OP Mainnet.
