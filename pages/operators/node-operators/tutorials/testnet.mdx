...
*   If you've already got your node up and running, check out the [Node Metrics and Monitoring Guide](/operators/chain-operators/management/metrics) to learn how to keep tabs on your node and make sure it keeps running smoothly.
