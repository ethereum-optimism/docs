...
2.  Wait for the next output root to be submitted to L1 (you can see this on [the SDK](/tools/javascript/sdk)) and then submit the withdrawal proof using `proveWithdrawalTransaction`.
