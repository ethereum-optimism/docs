...
After you are done with that development, debug your decentralized application using either a [development node](/stack/chain/testing/dev-node) or the [Sepolia test network](/stack/chain/networks).
