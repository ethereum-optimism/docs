...
![The OP Stack components.](/img/op-stack/protocol/components.png)
...
*   [Specifications](https://github.com/ethereum-optimism/specs/blob/main/specs/derivation.md#batch-submission-wire-format)
...
*   [Specifications](https://github.com/ethereum-optimism/specs/blob/main/specs/derivation.md#l2-chain-derivation-pipeline)
...
*   [Specifications](https://github.com/ethereum-optimism/specs/blob/main/specs/exec-engine.md) (where it differs from [geth](https://geth.ethereum.org/))
...
*   [Specifications](https://github.com/ethereum-optimism/specs/blob/main/specs/withdrawals.md) (called [withdrawal transactions](/builders/dapp-developers/bridging/messaging))
