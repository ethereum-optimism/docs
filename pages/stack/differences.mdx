...
[By default, transaction costs on OP Stack chains](/stack/transaction-fees/overview) include an [L2 execution fee](/stack/transaction-fees/overview#the-l2-execution-fee) and an [L1 data fee](/stack/transaction-fees/overview#the-l1-data-fee).
