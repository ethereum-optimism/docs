---
title: Differences between OP Stack and L1 Ethereum
lang: en-US
description: Learn the minor differences between the behavior of Optimism and Ethereum.
---
...
This contract is a predeploy at address [`0x4200000000000000000000000000000000000015`](https://optimistic.etherscan.io/address/0x4200000000000000000000000000000000000015).
...
There are several differences in the way blocks are produced between L1 Ethereum and Optimism.

| Parameter           | L1 Ethereum    | Optimism         |
| ------------------- | -------------- | ---------------- |
...
**Note:** The L1 Ethereum parameter values are taken from [ethereum.org](https://ethereum.org/en/developers/docs/blocks/#block-time). The Optimism values are taken from [the Optimism specs](https://github.com/ethereum-optimism/optimism/blob/129032f15b76b0d2a940443a39433de931a97a44/specs/guaranteed-gas-market.md#limiting-guaranteed-gas).
...
[By default, transaction costs on OP Stack chains](/stack/transactions/transaction-fees) include an [L2 execution fee](/stack/transactions/transaction-fees#the-l2-execution-fee) and an [L1 data fee](/stack/transactions/transaction-fees#the-l1-data-fee).
