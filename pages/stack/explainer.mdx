...
<Callout type="info">
  Stay up to date on the Superchain and the OP Stack by subscribing to the [Optimism newsletter](https://optimism.us6.list-manage.com/subscribe/post?u=9727fa8bec4011400e57cafcb&id=ca9104223&f_id=002a19e3f0).
</Callout>
