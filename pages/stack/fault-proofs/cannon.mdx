...
Once an active fault dispute game reaches a depth below attacking / defending L2 block state transitions, [OP-Challenger](/concepts/architecture/fault-proofs/op-challenger) will run
