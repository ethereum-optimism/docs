...
*   For more info about how fault proofs works under the hood,
    [check out the specs](https://specs.optimism.io/experimental/fault-proof/stage-one/bond-incentives.html).
*   Read the explainer guide on [op-challenger](/challenger).
*   Read the explainer guide on [cannon](/cannon).
*   Read about the [components of the fault proof](/fp-components) system and how they work together to enhance decentralization.
