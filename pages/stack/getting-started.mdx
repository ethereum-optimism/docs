...
As the [Superchain](explainer) begins to take shape, the OP Stack can evolve alongside it, to include the message-passing infrastructure (e.g. [NodeKit](https://nodekit.xyz/)) that allows different chains to interoperate seamlessly.
