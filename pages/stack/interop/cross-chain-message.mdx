...
A cross-chain message applies to any message sent using Superchain interop - this includes sending across chains within an interop cluster, but also chains interoperating with themselves. This functionality applies to asset transfers using the [SuperchainERC20](superchain-erc20) token standard. 
