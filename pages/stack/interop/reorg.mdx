...
But once the block is posted to L1, that is the correct block for the blockchain, barring L1 reorgs.
...
Sequencer inform the rest of the Superchain about a new block in two ways:
