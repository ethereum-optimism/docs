...
If using another verification mechanism you likely will need to maintain a token registry per chain that indicates the valid address mapping to facilitiate cross-chain mint/burns when moving across chains. 
