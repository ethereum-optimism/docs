...
| Explorer                    | 'TBA' |
| Public RPC URL              | 'https://interop-alpha-0.optimism.io' |
| Sequencer URL               | 'https://interop-alpha-0.optimism.io' |
...
| Currency Symbol<sup>1</sup> | ETH   |
| Explorer                    | 'TBA' |
| Public RPC URL              | 'https://interop-alpha-1.optimism.io' |
| Sequencer URL               | 'https://interop-alpha-1.optimism.io' |
