...
<Callout>
  ...
  If you just want a working code example, [see here](#use-the-eth-optimismviem-library-to-relay-the-message).
</Callout>
...
To verify that the chains are running, check the balance of `$ADDR`.
