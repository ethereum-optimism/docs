...
1. To map the `interop-lib` library correctly, create a `remappings.txt` file.

    ```text filename="remappings.txt"
    @interop-lib/=lib/superchainerc20-starter/packages/contracts/lib/interop-lib/src/
    ```

1. Deploy `SuperchainERC20` to both chains, and keep the addresses in environment variables.
...
cast send 0x5FbDB2315678afecb367f032d93F642f64180aa3 --rpc-url http://localhost:9546 --private-key 0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80 "deploy(address,address,bytes)" 0x5FbDB2315678afecb367f032d93F642f64180aa3 0x5FbDB2315678afecb367f032d93F642f64180aa3 0x
