...
<details>
  ...
  *   You should already know how to [deploy SuperchainERC20 tokens with custom code](/stack/interop/tutorials/).
</details>
...
<Steps>
  ...
  1.  Create an `script/LabSetup.s.sol` file with this content:
      ...
      ```solidity file=<rootDir>/public/tutorials/setup-for-erc20-upgrade.sh#L26-L66 hash=83e951ca27872311bd7ae734c24cdbc2 filename="script/LabSetup.s.sol"
      ```
  ...
  <Callout>
    ...
    *   [Lockboxes](#lockboxes-for-permissionless-interop) allows any existing ERC20 to become compatible with Superchain interop.
        The Lockbox is just a simple wrapper contract, analogous to Wrapped ETH.
