...
See [Cannon VM Specs](https://specs.optimism.io/experimental/fault-proof/cannon-fault-proof-vm.html#state) for
...
can be used to resolve disputes. See [MIPS reference](mips) for an alternative FPVM that can be used.
