...
single L2 output root state transition that they disagree on.

### OP-Challenger \<> Cannon

Once an active fault dispute game reaches a depth below attacking / defending L2 output root state transitions, OP-Challenger will run
