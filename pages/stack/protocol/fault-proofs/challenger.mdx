...
`op-challenger` evaluates each claim's validity in every game, deciding to counter only those it deems invalid. An honest challenger uses this basic logic:
