...
*   See [Cannon FPVM](cannon) for more detail on Cannon and its default operation as part of Optimism's Fault Proof Virtual Machine.
*   See [FP Mainnet Security](fp-security) for a detailed walk-thru of significant changes to Fault Proof Mainnet.
