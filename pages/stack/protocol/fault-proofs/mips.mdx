...
This smart contract is the counterpart to the off-chain MIPSEVM golang implementation of the same ISA. Together, the on-chain and off-chain VM implementations make up [Cannon](cannon),
