...
The `OptimismPortal` contract is an L1 smart contract that can be used by both smart contracts and <Reference>EOAs</Reference> to create L2 transactions without the direct involvement of the Sequencer.
