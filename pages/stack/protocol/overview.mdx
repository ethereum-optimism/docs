...
Checkout the [protocol specs](https://github.com/ethereum-optimism/optimism/tree/v1.1.4/specs), if you want to more detail about the rollup protocol.
...
Blocks are written to L1 in [a compressed format](https://github.com/ethereum-optimism/optimism/blob/v1.1.4/specs/derivation.md#batch-submission-wire-format) to reduce costs.
This is important because writing to L1 is [the major cost of OP Mainnet transactions](/stack/transactions/transaction-fees).
...
1.  Transactions submitted on L1 (called *deposits*) are included in the chain in the appropriate L2 block.
    ...
    You can read more about this mechanism [in the protocol specifications](https://github.com/ethereum-optimism/optimism/blob/v1.1.4/specs/derivation.md#deriving-the-transaction-list).
...
1.  The execution engine can update itself using peer to peer network with other execution engines.
    ...
    You can read more about it [in the specs](https://github.com/ethereum-optimism/optimism/blob/v1.1.4/specs/exec-engine.md#happy-path-sync).
...
2.  The rollup node (implemented as the `op-node` component) derives the L2 blocks from L1.
    ...
    You can read more about it [in the specs](https://github.com/ethereum-optimism/optimism/blob/v1.1.4/specs/exec-engine.md#worst-case-sync).
...
You can read more about this [in the specs](https://github.com/ethereum-optimism/optimism/blob/v1.1.4/specs/deposits.md).
...
[You can read the full withdrawal specifications here](https://github.com/ethereum-optimism/optimism/blob/v1.1.4/specs/withdrawals.md)
