...
Checkout the [protocol specs](https://github.com/ethereum-optimism/optimism/tree/develop/specs), if you want to more detail about the rollup protocol.
...
2.  Wait for the next output root to be submitted to L1 (you can see this on [the SDK](/builders/tools/javascript/sdk)) and then submit the withdrawal proof using `proveWithdrawalTransaction`.
