...
*   Transaction finality: The point at which a transaction is considered irreversible.
*   Challenge period: A period during which withdrawals from L2 to L1 can be contested.
*   Reorg: A situation where part of the blockchain is replaced, discarding previously confirmed blocks.
