...
<Callout type="info">
  To increase your level of security you should only use governance approved 
  and audited smart contracts. The monorepo has them tagged with the following
  pattern `op-contracts/vX.X.X` and you can review the release notes for 
  details on the changes.
</Callout>

This guide explains how smart contracts work at a high level and outlines the
governance approved and audited version of the smart contract protocol.
...
todo: call out MCP is still being voted on
...
callout that this isn't gov approved
