...
The batcher aggregates [sequencer batches](https://github.com/ethereum-optimism/specs/blob/main/specs/glossary.md#sequencer-batch) into [channels](https://github.com/ethereum-optimism/specs/blob/main/specs/glossary.md#channel).
This allows for more data per compression frame, and therefore a better compression ratio.
You can read more about this process [in the specs](https://github.com/ethereum-optimism/specs/blob/main/specs/derivation.md#batch-submission).
