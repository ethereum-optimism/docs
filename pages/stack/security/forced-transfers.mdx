---
title: Forcing Transfers from an OP Stack Blockchain
lang: en-US
description: Learn how to move on-chain ETH or tokens on an OP Stack blockchain directly from L1.
---

import { Callout, Steps } from 'nextra/components'

# Forcing Transfers from an OP Stack Blockchain

Any ETH or tokens you own on an OP Stack blockchain are backed by equivalent tokens on the underlying L1, locked in a bridge.
In this tutorial, you learn how to withdraw these tokens directly from L1.
...
<Steps>
  ...
  *   Create a `Greeter.sol` file
  ...
  | PRIV\_KEY              | Private key for an address that has ETH on L2. It also needs ETH on L1 to submit transactions |
...
<Steps>
  ...
  ### Create a contract object for the [`OptimismPortal`](https://github.com/ethereum-optimism/optimism/blob/v1.1.4/packages/contracts-bedrock/src/L1/OptimismPortal.sol) contract
  ...
  ### Create the object for the L1 contracts, as explained in [the documentation](https://sdk.optimism.io)
