...
The Holocene upgrade is a large network upgrade. Learn more about it in the [Holocene notice page](https://docs.optimism.io/notices/holocene-changes).
...
### 1. Clone the repository and checkout the upgrade branch

```sh
git clone https://github.com/ethereum-optimism/optimism.git
cd optimism
git checkout perm/op-contracts/v1.8.0/packages/contracts-bedrock/scripts/upgrades/v1.3.0/v1.8.0-permissioned
```
