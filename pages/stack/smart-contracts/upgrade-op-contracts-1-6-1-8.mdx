...
Before starting, make sure you have access to your chain's `deployments.json` and `deploy-config.json`.

You might need to make some edits to your files, to ensure all the info is there and address names are correct:

`deployments.json`:
```
{
- rename to AddressManager "Lib_AddressManager": "0xEF8115234234237c756402Fc1deaa56550Ef",
  "L2OutputOracleProxy": "0x9E6204F2341423909123we5f95c",
  "OptimismMintableERC20FactoryProxy": "0xc52BC712391090idsaklmasBcFf",
- rename to L1StandardBridgeProxy "Proxy__OVM_L1StandardBridge": "0x3e2Ea9B92ewm1ioo12389195284631",
  "ProxyAdmin": "0xD4ef175B9e72cAEe9f1fe7660a6Ec19009903b49",
- rename to L1CrossDomainMessengerProxy "Proxy__OVM_L1CrossDomainMessenger": "0xdC40a14d9abd6F41283989jads03441ca506",
  "L1ERC721BridgeProxy": "0x831231asda87f3a971B169C5A0E1d34481c3",
  "OptimismPortalProxy": "0x1a0123res30f69f6A19DF447A0CfD9551054",
  "SystemConfigProxy": "0xA3cA2312easdasq23543fe212BBBF17930d86"
}
```
...
- check this address is the actually the current one from the SCR "systemConfigOwner": "0xC72aE5c7cc9a332699305E29F68Be66c73b60542",
- same as PortalGuardian "superchainConfigGuardian": "0x9BA6e03D8B90dE867373Db8cF1A58d2F7F006b3A",
...
- make sure this is the STANDARD Guardian "portalGuardian": "0xC72aE5c7cc9a332699305E29F68Be66c73b60542",
  "l2OutputOracleSubmissionInterval": 180,
  "l2OutputOracleStartingTimestamp": -1,
  "l2OutputOracleStartingBlockNumber": "0x0",
- make sure it's the Chain Operator's  "l2OutputOracleProposer": "0x48247032092e7b0ecf5dEF611ad89eaf3fC888Dd",
- make sure it's updated to the PAO "l2OutputOracleOwner": "0xDA1F62857EA7f10444725c6c435235243D623540",
  ...
  "eip1559Elasticity": 6,
- make sure this is updated from SCR chain toml "proxyAdmin": "0x027860cA56cF779371461C14c3a483c94e1aA8a0",
- make sure this is updated from SCR chain toml  "proxyAdminOwner": "0xb0cCdbD6fe09D2199171BE19450aF249250518A0",
...
- update this to the STANDARD role Challenger "l2OutputOracleChallenger": "0xcA4571b1ecBeC86Ea2E660d242c1c29FcB55Dc72",
- add the below if not in the config 
  "useFaultProofs": true,
...
- make sure it's updated to the latest "faultGameAbsolutePrestate": "0x03925193e3e89f87835bbdf3a813f60b2aa818a36bbe71cd5d8fd7e79f52bafe",
...
- make sure to add the below if not present already, these value won't matter but the script needs them to be present in the config  
...
Update your `.env` file with the required information. Here's an [example `.env` files](https://github.com/ethereum-optimism/optimism/blob/a7a4c10c79c3c8546a11c002773246cd54d380e2/packages/contracts-bedrock/scripts/upgrades/holocene/.env.example).
