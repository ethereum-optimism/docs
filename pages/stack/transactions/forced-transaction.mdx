...
*   **Mitigate censorship:** Forced transactions act as an escape hatch so users can ensure their transactions are processed even if the sequencer attempts to censor them.
