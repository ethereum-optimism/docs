...
_ The sequencer comes back online, or
_ The 12-hour sequencing window expires.

### Prolonged downtime (> 12 hours)

1.  After 12 hours, nodes start generating blocks deterministically.
2.  These blocks include only deposit transactions.
3.  When the sequencer returns:
    - All deposit transactions are included first.
    - No regular L2 transactions are included until the L2 chain is within 12 hours of the L1 chain.
