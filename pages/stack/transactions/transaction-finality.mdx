...
The reality is the OP Stack transaction finality takes minutes, not over a week. This section detangles the concept of transaction finality and the Fault Proof System's challenger mechanism.
...
The Fault Proof System is designed to ensure the accuracy of certain claims about the transaction state on the L2.
