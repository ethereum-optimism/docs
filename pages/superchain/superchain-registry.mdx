...
You can find more details in the [Standard Rollup Charter documentation](/governance/blockspace-charter).

<Callout type="info">
  We **strongly** recommend using the [op-deployer](/chain-operators/tools/op-deployer) to deploy L1 contracts and generate the L2 genesis file that meets the configuration requirements outlined in the [Standard Rollup Charter](/governance/blockspace-charter).
</Callout>
