...
To see how to send these messages, see [the cross domain tutorial](/dapp-developers/bridging/messaging) or the tutorials on how to transfer [ETH](/dapp-developers/bridging/cross-dom-bridge-eth) and [ERC-20](/dapp-developers/bridging/cross-dom-bridge-erc20).
