...
To see how to send these messages, see [the cross domain tutorial](/dapp-developers/bridging/messaging) or the tutorials on how to transfer [ETH](/dapp-developers/tutorials/cross-dom-bridge-eth) and [ERC-20](/dapp-developers/tutorials/cross-dom-bridge-erc20).
