...
[The EIP-1559 parameters](/differences#eip-1559) have different values in OP Mainnet (and most other OP Stack chain) than those on L1 Ethereum.
...
[See here for a code sample using the JavaScript SDK](/tools/javascript/sdk-estimate-gas)
...
You can use the SDK [(see here)](/tools/javascript/sdk-estimate-gas).
