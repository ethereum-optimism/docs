      ...
      <div style={containerStyle}>
        <div style={topStyle}>
            ...
            <ul style={listStyle}>
              <li style={listItemStyle}>
                <a href="https://console.optimism.io/faucet?utm_source=op-docs&utm_medium=docs" 
                   style={linkStyle}
                   onMouseOver={(e) => e.target.style.color = '#FF0420'}
                   onMouseOut={(e) => e.target.style.color = '#666'}>
                  Superchain Faucet
                </a>
              </li>
              <li style={listItemStyle}>
                <a href="https://optimistic.grafana.net/public-dashboards/c84a5a9924fe4e14b270a42a8651ceb8" 
                   style={linkStyle}
                   onMouseOver={(e) => e.target.style.color = '#FF0420'}
                   onMouseOut={(e) => e.target.style.color = '#666'}>
                  Gas Tracker
              ...
              <li style={listItemStyle}>
                <a href="https://status.optimism.io/?utm_source=op-docs&utm_medium=docs" 
                   style={linkStyle}
                   onMouseOver={(e) => e.target.style.color = '#FF0420'}
                   onMouseOut={(e) => e.target.style.color = '#666'}>
                  Service Status
              ...
              <li style={listItemStyle}>
                <a href="https://github.com/ethereum-optimism/optimism/releases" 
                   style={linkStyle}
                   onMouseOver={(e) => e.target.style.color = '#FF0420'}
                   onMouseOut={(e) => e.target.style.color = '#666'}>
                  Changelog
              ...
              <li style={listItemStyle}>
                <a href="https://devnets.optimism.io/?utm_source=op-docs&utm_medium=docs" 
                   style={linkStyle}
                   onMouseOver={(e) => e.target.style.color = '#FF0420'}
                   onMouseOut={(e) => e.target.style.color = '#666'}>
                  Devnets
          ...
          <section style={sectionStyle}>
            ...
            <ul style={listStyle}>
              <li style={listItemStyle}>
                <a href="https://github.com/ethereum-optimism/developers/discussions" 
                   style={linkStyle}
                   onMouseOver={(e) => e.target.style.color = '#FF0420'}
                   onMouseOut={(e) => e.target.style.color = '#666'}>
                  Developer Support
              ...
              <li style={listItemStyle}>
                <a href="https://guild.xyz/superchain-devs" 
                   style={linkStyle}
                   onMouseOver={(e) => e.target.style.color = '#FF0420'}
                   onMouseOut={(e) => e.target.style.color = '#666'}>
              ...
              <li style={listItemStyle}>
                <a href="https://share.hsforms.com/1yENj8CV9TzGYBASD0JC8_gqoshb" 
                   style={linkStyle}
                   onMouseOver={(e) => e.target.style.color = '#FF0420'}
                   onMouseOut={(e) => e.target.style.color = '#666'}>
                  Get Launch Support
              ...
              <li style={listItemStyle}>
                <a href="/connect/resources/glossary" 
                   style={linkStyle}
                   onMouseOver={(e) => e.target.style.color = '#FF0420'}
                   onMouseOut={(e) => e.target.style.color = '#666'}>
                  Glossary
              ...
              <li style={listItemStyle}>
                <a href="/connect/contribute/stack-contribute" 
                   style={linkStyle}
                   onMouseOver={(e) => e.target.style.color = '#FF0420'}
                   onMouseOut={(e) => e.target.style.color = '#666'}>
              ...
              <li style={listItemStyle}>
                <a href="https://specs.optimism.io/?utm_source=op-docs&utm_medium=docs" 
                   style={linkStyle}
                   onMouseOver={(e) => e.target.style.color = '#FF0420'}
                   onMouseOut={(e) => e.target.style.color = '#666'}>
                  Protocol Specs
          ...
          <section style={sectionStyle}>
            <h3 style={headingStyle}>Ecosystem</h3>
            <ul style={listStyle}>
              <li style={listItemStyle}>
                <a href="https://github.com/ethereum-optimism/ecosystem" 
                   style={linkStyle}
                   onMouseOver={(e) => e.target.style.color = '#FF0420'}
                   onMouseOut={(e) => e.target.style.color = '#666'}>
                  Ecosystem Packages
              ...
              <li style={listItemStyle}>
                <a href="https://github.com/ethereum-optimism/superchain-registry" 
                   style={linkStyle}
                   onMouseOver={(e) => e.target.style.color = '#FF0420'}
                   onMouseOut={(e) => e.target.style.color = '#666'}>
                  Superchain Registry
          ...
          <section style={sectionStyle}>
            ...
            <div style={socialIconsStyle}>
              <a href="https://discord.gg/optimism" 
              ...
              <a href="https://twitter.com/optimism" 
                 style={socialLinkStyle}
                 onMouseOver={(e) => e.target.style.color = '#FF0420'}
                 onMouseOut={(e) => e.target.style.color = '#666'}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href="https://github.com/ethereum-optimism/docs/" 
                 style={socialLinkStyle}
                 onMouseOver={(e) => e.target.style.color = '#FF0420'}
                 onMouseOut={(e) => e.target.style.color = '#666'}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div style={bottomStyle}>
          <div style={policyLinksStyle}>
            <a href="https://optimism.io/community-agreement?utm_source=op-docs&utm_medium=docs" 
               style={linkStyle}
               onMouseOver={(e) => e.target.style.color = '#FF0420'}
               onMouseOut={(e) => e.target.style.color = '#666'}>
              Community Agreement
            </a>
            <a href="https://optimism.io/terms?utm_source=op-docs&utm_medium=docs" 
               style={linkStyle}
               onMouseOver={(e) => e.target.style.color = '#FF0420'}
               onMouseOut={(e) => e.target.style.color = '#666'}>
              Terms of Service
            </a>
            <a href="https://optimism.io/data-privacy-policy?utm_source=op-docs&utm_medium=docs" 
               style={linkStyle}
               onMouseOver={(e) => e.target.style.color = '#FF0420'}
               onMouseOut={(e) => e.target.style.color = '#666'}>
              Privacy Policy
            </a>
            <a href="https://github.com/ethereum-optimism/docs?tab=coc-ov-file#readme" 
               style={linkStyle}
               onMouseOver={(e) => e.target.style.color = '#FF0420'}
               onMouseOut={(e) => e.target.style.color = '#666'}>
              Code of Conduct
          ...
          <div style={copyrightStyle}>
            © {new Date().getFullYear()} <a href="/" style={linkStyle}>Optimism Foundation. All rights reserved.</a>
          </div>
        </div>
      </div>
    </footer>
